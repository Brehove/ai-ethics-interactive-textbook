...
export type LayoutRegion = Record<string, unknown> & { layoutId: string; type: "wrap" | "card-text-split" | "card-grid"; startNodeId: string; endNodeId: string; ratio?: "equal" | "start-narrow" | "end-narrow" | "card-narrow" | "balanced" | "card-wide" };
