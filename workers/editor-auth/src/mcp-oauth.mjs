...
const READ_OPERATIONS = Object.freeze(["get_authoring_view", "get_passage", "get_layout_catalog", "get_card_layout", "get_valid_layout_options", "validate_layout_proposal", "get_version_history", "get_live_commit_status", "get_person", "search_persons", "search_media", "get_media_job", "get_media_asset"]);
const WRITE_OPERATIONS = Object.freeze(["create_or_resume_changeset", "replace_passage_text", "replace_chapter_document", "split_block", "join_blocks", "move_block", "upsert_checkpoint", "move_checkpoint", "remove_checkpoint", "reorder_checkpoint", "place_media", "upsert_embed", "resolve_provider_url", "upsert_person_feature", "move_managed_placement", "remove_managed_placement", "set_card_layout", "reset_card_layout", "set_card_frame", "clear_card_frame", "create_card_wrap", "create_card_group", "create_card_text_split", "update_layout_region", "remove_layout_region", "reconcile_layout_region", "preview_changes", "restore_revision_as_draft", "request_live_save_authorization"]);
