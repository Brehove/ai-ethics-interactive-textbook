...
Every v4 document pins `layoutCatalogVersion: "2026-08-05"`. Region IDs are generated by the Content API. Nodes cannot overlap regions, and flow movement or deletion fails until the owning region is removed or reconciled. See [ADR 0009](./architecture/adr/0009-flexible-card-layouts.md).
