...
<!-- phil-section-id: ch14-s001 -->
## Why "Just Software" Fails As A Category

<!-- phil-passage-id: ch14-p0005 -->
...
<!-- phil-passage-id: ch14-p0008 -->
Herbert Clark and Kerstin Fischer make this point carefully in ["Social Robots as Depictions of Social Agents"](https://doi.org/10.1017/S0140525X22000668). Their argument helps students avoid a common confusion. A social robot does not have to be a human-like agent in order to depict one. A puppet on a stage can depict a person without being one. A social robot can depict agency, attention, warmth, patience, or responsiveness. Users may respond to that depiction even while knowing what the artifact is.

<!-- phil-passage-id: ch14-p0009 -->
...
<!-- phil-passage-id: ch14-p0014 -->
<aside class="textbox shaded" role="note" aria-labelledby="caution-relationship-personhood">
  <h3 id="caution-relationship-personhood">Caution: Relationship Is Not Proof Of Personhood</h3>
  <p>A user may experience an AI companion as a friend, partner, pet, caregiver, or confidant. That experience has ethical significance. It does not prove that the system has consciousness, rights, or inner experience. The relation and the status question have to be judged separately.</p>
</aside>

<!-- phil-section-id: ch14-s002 -->
## What Kind Of Relation Is This?

<!-- phil-passage-id: ch14-p0015 -->
...
<!-- phil-section-id: ch14-s007 -->
### Accountability And Moral Hazard

<!-- phil-passage-id: ch14-p0031 -->
Bryson's view enters as the strongest challenge to this relational drift. In ["Robots Should Be Slaves"](https://researchportal.bath.ac.uk/en/publications/robots-should-be-slaves/) and ["Patiency Is Not a Virtue"](https://doi.org/10.1007/s10676-018-9448-6), Joanna Bryson argues that robots and AI systems are artifacts created by people. We should design them so responsibility remains with humans. If we start assigning moral standing to artificial systems too quickly, we may let designers, companies, owners, and institutions evade accountability. A robot does not enter the world by birth, vulnerability, community, and mortality. It is built, sold, updated, licensed, and controlled.

<!-- phil-passage-id: ch14-p0032 -->
...
<!-- phil-section-id: ch14-s008 -->
## What The Relationship Does To Us

<!-- phil-passage-id: ch14-p0040 -->
...
<!-- phil-section-id: ch14-s009 -->
### Care Ethics And The Goods Of Care

<!-- phil-passage-id: ch14-p0041 -->
...
<!-- phil-passage-id: ch14-p0045 -->
Shannon Vallor's ["Carebots and Caregivers: Sustaining the Ethical Ideal of Care in the Twenty-First Century"](https://doi.org/10.1007/s13347-011-0015-x) is central here. Vallor argues that debates about care robots often focus on the recipient of care while neglecting the moral value of caregiving for the caregiver. That shift matters. If care is only a service, then a machine that delivers the service efficiently may look like an obvious improvement. If care is also a practice through which human beings cultivate attention, patience, responsibility, tenderness, and practical judgment, then replacing human care has a second cost. It may harm the person receiving care, and it may also hollow out the moral formation of the person or community that should have been giving care.

<!-- phil-passage-id: ch14-p0046 -->
...
<!-- phil-section-id: ch14-s010 -->
### Carebots, Substitution, And Dignity

<!-- phil-passage-id: ch14-p0048 -->
...
<!-- phil-passage-id: ch14-p0050 -->
Robert and Linda Sparrow, Amanda Sharkey, and Noel Sharkey push from the skeptical side of the care-robot debate. This side is not simply "anti-technology." Philosophically, it combines dignity concerns, care-ethics concerns about substitution, and a Kantian worry that vulnerable persons may be managed through appearances while being denied recognition as persons. In ["In the Hands of Machines? The Future of Aged Care"](https://doi.org/10.1007/s11023-006-9030-6), Robert and Linda Sparrow argue that aged care is not only a list of tasks. Older adults have social and emotional needs, and many of those needs require human recognition. If economic pressure leads institutions to replace human contact with machines, then the robot may become a sign of abandonment disguised as care.

<!-- phil-passage-id: ch14-p0051 -->
Amanda Sharkey and Noel Sharkey develop related concerns around deception and dignity. In ["Granny and the Robots"](https://doi.org/10.1007/s10676-010-9234-6), they identify risks such as reduced human contact, increased isolation, deception, infantilization, and safety failures. Their later article ["We Need to Talk About Deception in Social Robotics"](https://doi.org/10.1007/s10676-020-09573-9) is especially useful because it treats deception from the perspective of the person deceived, not only from the intention of the designer. A robot can mislead without a human designer consciously lying. Its appearance, voice, behavior, or scripted responsiveness can lead a user to overestimate its understanding, sentience, function, or concern. That matters in care contexts because the user may be vulnerable, lonely, cognitively impaired, or institutionally dependent. If a facility uses a robot to supplement human care, one judgment follows. If the robot becomes a cheap replacement for human presence, another judgment follows. If a person receives comfort through a system that simulates responsiveness without understanding, we need to ask whether the comfort respects the person or manages the person.

<!-- phil-passage-id: ch14-p0052 -->
...
<!-- phil-section-id: ch14-s012 -->
### Virtue Ethics And Practical Wisdom

<!-- phil-passage-id: ch14-p0059 -->
...
<!-- phil-passage-id: ch14-p0065 -->
The contested phrase "AI psychosis" belongs in this section only with care. Clinical sources such as the JMIR Mental Health viewpoint on ["Delusional Experiences Emerging From AI Chatbot Interactions or 'AI Psychosis'"](https://mental.jmir.org/2025/1/e85799/) and the National Academy of Medicine's ["What is AI Psychosis?"](https://nam.edu/news-and-insights/what-is-ai-psychosis/) treat the language cautiously. As of 2025-2026, it is not a settled diagnosis. It is public shorthand for AI-associated delusional experiences, delusion reinforcement, reality confusion, or crisis. Online communities may also use the term in looser, sometimes self-descriptive ways while exploring metaphysical, spiritual, or identity experiences with AI systems.

<!-- phil-passage-id: ch14-p0066 -->
...
<!-- phil-passage-id: ch14-p0068 -->
<aside class="textbox shaded" role="note" aria-labelledby="key-point-care-practice">
  <h3 id="key-point-care-practice">Key Point: Care Is A Practice, Not Only A Feeling</h3>
  <p>A companion may make a user feel cared for. Care ethics asks more. Who is attending to the person? Who is responsible? What human practice is being supported or replaced? What happens to the user's dignity, agency, and relationships over time?</p>
</aside>

<!-- phil-passage-id: ch14-p0069 -->
...
<!-- phil-section-id: ch14-s014 -->
## Who Is Responsible For The Design?

<!-- phil-passage-id: ch14-p0070 -->
...
<!-- phil-section-id: ch14-s015 -->
### Autonomy And Manipulation

<!-- phil-passage-id: ch14-p0071 -->
...
<!-- phil-section-id: ch14-s016 -->
### Hypernudging And Design Power

<!-- phil-passage-id: ch14-p0078 -->
The larger concept is regulation by design. A companion system does not need to command a user in order to guide behavior. It can make one option easier to notice, another harder to imagine, one habit smoother, another more effortful. Karen Yeung calls this pattern ["hypernudging"](https://doi.org/10.1080/1369118X.2016.1186713): Big Data systems can steer behavior through continuously updated, personalized prompts. Liu's fictional assistant is a literary version of that idea. Tilly does not rule by force. It suggests, routes, filters, learns, anticipates, and makes one path feel natural while other paths fade from view.

<!-- phil-passage-id: ch14-p0079 -->
The same design problem becomes sharper when the system has a commercial incentive. Ryan Calo's ["Digital Market Manipulation"](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2309703) explains how digital systems can study users closely enough to personalize persuasion. Woodrow Hartzog's [*Privacy's Blueprint*](https://www.hup.harvard.edu/books/9780674976009) pushes the point into design ethics: privacy and autonomy are shaped by interface choices, defaults, friction, timing, and architecture. A privacy policy may tell the user what data is collected. It rarely shows the user how the interface will shape attention, trust, and disclosure at the moment of use. For companion systems, that gap matters because the interface is not only a menu or dashboard. It is a voice, persona, memory, and relationship pattern.

<!-- phil-section-id: ch14-s017 -->
### Cloud Control And Offboarding

<!-- phil-passage-id: ch14-p0080 -->
...
<!-- phil-passage-id: ch14-p0086 -->
<aside class="textbox shaded" role="note" aria-labelledby="key-point-relational-safety">
  <h3 id="key-point-relational-safety">Key Point: Relational Safety Is A Design Problem</h3>
  <p>Companion safety goes beyond a warning label. It can involve disclosure, reminders during sustained use, age assurance, crisis-routing or self-harm protocols, limits on minors' open-ended chat, evaluation for sycophancy or delusion reinforcement, and business incentives around engagement. These are design choices as well as user choices.</p>
</aside>

<!-- phil-section-id: ch14-s019 -->
### Consequences, Baselines, And Stakeholders

<!-- phil-passage-id: ch14-p0087 -->
...
<!-- phil-passage-id: ch14-p0098 -->
<aside class="textbox shaded" role="note" aria-labelledby="caution-disclosure-incomplete">
  <h3 id="caution-disclosure-incomplete">Caution: Disclosure Is Necessary And Incomplete</h3>
  <p>A companion should tell users that it is an AI. That alone does not settle the ethical issue. A system can disclose its artificial status and still invite excessive trust through memory, tone, personalization, crisis response, and constant availability.</p>
</aside>

<!-- phil-passage-id: ch14-p0099 -->
...
<!-- phil-section-id: ch14-s020 -->
## A Companion Judgment Audit

<!-- phil-passage-id: ch14-p0100 -->
...
<!-- phil-passage-id: ch14-p0105 -->
Finally, test the case through ethical frameworks.

<!-- phil-passage-id: ch14-p0106 -->
...
<!-- phil-passage-id: ch14-p0115 -->
A strong companion judgment might sound like this:

<!-- phil-passage-id: ch14-p0116 -->
<aside class="textbox examples" aria-labelledby="model-application-relationship-environment">
  <h3 id="model-application-relationship-environment">Model Application: A Designed Relationship Environment</h3>
  <p>This system should be judged mainly as a designed relationship environment. The companion may provide real support for lonely users, so dismissing it as fake misses something important. Still, the strongest ethical concern is that the company controls the relation, shapes the user's trust, and may benefit from continued dependence. Care ethics helps identify the user's need for support, Kantian ethics helps identify manipulation and autonomy concerns, and consequentialism helps ask what evidence would show benefit over time. I would not frame this as a robot-rights case unless the argument clearly explains why duties are owed to the system itself.</p>
</aside>

<!-- phil-passage-id: ch14-p0117 -->
...
<!-- phil-passage-id: ch14-p0121 -->
Luciano Floridi and J. W. Sanders, ["On the Morality of Artificial Agents"](https://link.springer.com/article/10.1023/B%3AMIND.0000035461.63578.9d), *Minds and Machines* 14, 2004.

<!-- phil-passage-id: ch14-p0122 -->
Henry Shevlin, ["How Could We Know When a Robot Was a Moral Patient?"](https://pubmed.ncbi.nlm.nih.gov/34109927/), *Cambridge Quarterly of Healthcare Ethics* 30, no. 3, 2021.

<!-- phil-passage-id: ch14-p0123 -->
Sven Nyholm, ["The Ethics of Human-Robot Interaction and Traditional Moral Theories"](https://research-portal.uu.nl/en/publications/the-ethics-of-humanrobot-interaction-and-traditional-moral-theori/), in *The Oxford Handbook of Digital Ethics*, Oxford University Press, 2024.

<!-- phil-passage-id: ch14-p0124 -->
Vincent C. Mueller, ["Ethics of Artificial Intelligence and Robotics"](https://plato.stanford.edu/entries/ethics-ai/), *Stanford Encyclopedia of Philosophy*, current version checked July 2026.

<!-- phil-passage-id: ch14-p0125 -->
Mark Coeckelbergh, ["Robot Rights? Towards a Social-Relational Justification of Moral Consideration"](https://doi.org/10.1007/s10676-010-9235-5), *Ethics and Information Technology* 12, 2010.

<!-- phil-passage-id: ch14-p0126 -->
David J. Gunkel, ["The Other Question: Can and Should Robots Have Rights?"](https://doi.org/10.1007/s10676-017-9442-4), *Ethics and Information Technology* 20, 2018.

<!-- phil-passage-id: ch14-p0127 -->
Kate Darling, ["Extending Legal Protection to Social Robots"](https://doi.org/10.2139/ssrn.2044797), SSRN, 2012/2016.

<!-- phil-passage-id: ch14-p0128 -->
John Basl and Joseph Bowen, ["AI as a Moral Right-Holder"](https://academic.oup.com/edited-volume/34287), in *The Oxford Handbook of Ethics of AI*, Oxford University Press, 2020. Canon signal for AI moral-right-holder debates; not a major body source in this draft.

<!-- phil-passage-id: ch14-p0129 -->
Judith Donath, ["Ethical Issues in Our Relationship with Artificial Entities"](https://academic.oup.com/edited-volume/34287), in *The Oxford Handbook of Ethics of AI*, Oxford University Press, 2020. Canon signal for relationship framing; not a major body source in this draft.

<!-- phil-passage-id: ch14-p0130 -->
John Danaher, ["The Philosophical Case for Robot Friendship"](https://doi.org/10.5325/JPOSTSTUD.3.1.0005), *Journal of Posthuman Studies* 3, no. 1, 2019.

<!-- phil-passage-id: ch14-p0131 -->
Joanna J. Bryson, ["Robots Should Be Slaves"](https://researchportal.bath.ac.uk/en/publications/robots-should-be-slaves/), in *Close Engagements with Artificial Companions*, John Benjamins, 2010.

<!-- phil-passage-id: ch14-p0132 -->
Joanna J. Bryson, ["Patiency Is Not a Virtue: The Design of Intelligent Systems and Systems of Ethics"](https://doi.org/10.1007/s10676-018-9448-6), *Ethics and Information Technology* 20, 2018.

<!-- phil-passage-id: ch14-p0133 -->
Abeba Birhane, Jelle van Dijk, and Frank Pasquale, ["Debunking Robot Rights Metaphysically, Ethically, and Legally"](https://firstmonday.org/ojs/index.php/fm/article/view/13628), *First Monday* 29, no. 4, 2024.

<!-- phil-passage-id: ch14-p0134 -->
Pat Pataranutaporn, Sheer Karny, Chayapatr Archiwaranguprok, Constanze Albrecht, Auren R. Liu, and Pattie Maes, ["My Boyfriend is AI: A Computational Analysis of Human-AI Companionship in Reddit's AI Community"](https://arxiv.org/html/2509.11391v2), arXiv:2509.11391v2, 2025. Treat as preprint / community-discourse evidence unless final publication metadata is verified.

<!-- phil-passage-id: ch14-p0135 -->
Shannon Vallor, ["Carebots and Caregivers: Sustaining the Ethical Ideal of Care in the Twenty-First Century"](https://doi.org/10.1007/s13347-011-0015-x), *Philosophy & Technology* 24, 2011.

<!-- phil-passage-id: ch14-p0136 -->
Robert Sparrow and Linda Sparrow, ["In the Hands of Machines? The Future of Aged Care"](https://doi.org/10.1007/s11023-006-9030-6), *Minds and Machines* 16, 2006.

<!-- phil-passage-id: ch14-p0137 -->
Amanda Sharkey and Noel Sharkey, ["Granny and the Robots: Ethical Issues in Robot Care for the Elderly"](https://doi.org/10.1007/s10676-010-9234-6), *Ethics and Information Technology* 14, 2012.

<!-- phil-passage-id: ch14-p0138 -->
Amanda Sharkey and Noel Sharkey, ["We Need to Talk About Deception in Social Robotics"](https://doi.org/10.1007/s10676-020-09573-9), *Ethics and Information Technology* 23, 2021.

<!-- phil-passage-id: ch14-p0139 -->
Sherry Turkle, ["Authenticity in the Age of Digital Companions"](https://doi.org/10.1075/is.8.3.11tur), *Interaction Studies* 8, no. 3, 2007.

<!-- phil-passage-id: ch14-p0140 -->
Daniel Susser, Beate Roessler, and Helen Nissenbaum, ["Technology, Autonomy, and Manipulation"](https://policyreview.info/articles/analysis/technology-autonomy-and-manipulation), *Internet Policy Review* 8, no. 2, 2019.

<!-- phil-passage-id: ch14-p0141 -->
Karen Yeung, ["Hypernudge: Big Data as a Mode of Regulation by Design"](https://doi.org/10.1080/1369118X.2016.1186713), *Information, Communication & Society* 20, no. 1, 2017.

<!-- phil-passage-id: ch14-p0142 -->
Ryan Calo, ["Digital Market Manipulation"](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=2309703), *George Washington Law Review* 82, 2014.

<!-- phil-passage-id: ch14-p0143 -->
Woodrow Hartzog, [*Privacy's Blueprint: The Battle to Control the Design of New Technologies*](https://www.hup.harvard.edu/books/9780674976009), Harvard University Press, 2018.

<!-- phil-passage-id: ch14-p0144 -->
OpenAI, [GPT-4o System Card](https://openai.com/index/gpt-4o-system-card/), 2024, and ["Sycophancy in GPT-4o"](https://openai.com/index/sycophancy-in-gpt-4o/), 2025. Company safety and postmortem sources; do not treat as independent prevalence evidence.

<!-- phil-passage-id: ch14-p0145 -->
Anthropic, ["How people ask Claude for personal guidance"](https://www.anthropic.com/research/claude-personal-guidance), ["How people use Claude for support, advice, and companionship"](https://www.anthropic.com/news/how-people-use-claude-for-support-advice-and-companionship), and ["Protecting the well-being of users"](https://www.anthropic.com/news/protecting-well-being-of-users). Company-authored sources; useful for company self-understanding.

<!-- phil-passage-id: ch14-p0146 -->
Federal Trade Commission, ["FTC Launches Inquiry into AI Chatbots Acting as Companions"](https://www.ftc.gov/news-events/news/press-releases/2025/09/ftc-launches-inquiry-ai-chatbots-acting-companions), September 11, 2025. Official inquiry, not findings.

<!-- phil-passage-id: ch14-p0147 -->
California Legislature, [SB 243: Companion chatbots](https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202520260SB243), Chapter 677, approved and filed October 13, 2025.

<!-- phil-passage-id: ch14-p0148 -->
New York Governor's Office, ["Governor Hochul Pens Letter to AI Companion Companies Notifying Them Safeguard Requirements Are Now in Effect"](https://www.governor.ny.gov/news/governor-hochul-pens-letter-ai-companion-companies-notifying-them-safeguard-requirements-are), November 2025. Official implementation announcement; verify statutory text before detailed legal analysis.

<!-- phil-passage-id: ch14-p0149 -->
Australia eSafety Commissioner, ["eSafety requires providers of AI companion chatbots to explain how they are keeping Aussie kids safe"](https://www.esafety.gov.au/newsroom/media-releases/esafety-requires-providers-of-ai-companion-chatbots-to-explain-how-they-are-keeping-aussie-kids-safe), 2026. Official legal-notice announcement; use as comparative regulator example.

<!-- phil-passage-id: ch14-p0150 -->
Ofcom, ["Ofcom investigates AI companion chatbot service"](https://www.ofcom.org.uk/online-safety/illegal-and-harmful-content/ofcom-investigates-ai-companion-chatbot-service), 2026. Official investigation announcement; use narrowly around Online Safety Act duties, age assurance, and pornographic-material access.

<!-- phil-passage-id: ch14-p0151 -->
Ryan K. McBain et al., ["AI Chatbots for Mental Health Advice Among Adolescents and Young Adults"](https://jamanetwork.com/journals/jamapediatrics/fullarticle/2849307), *JAMA Pediatrics*, 2026. Cross-sectional self-report survey; use for youth mental-health advice seeking, not therapy efficacy.

<!-- phil-passage-id: ch14-p0152 -->
Janne Joranson et al., ["Effects on Symptoms of Agitation and Depression in Persons With Dementia Participating in Robot-Assisted Activity: A Cluster-Randomized Controlled Trial"](https://pmc.ncbi.nlm.nih.gov/articles/PMC4433493/), *Journal of the American Medical Directors Association* 16, no. 10, 2015.

<!-- phil-passage-id: ch14-p0153 -->
Hudon and Stip, ["Delusional Experiences Emerging From AI Chatbot Interactions or 'AI Psychosis'"](https://mental.jmir.org/2025/1/e85799/), *JMIR Mental Health*, 2025.

<!-- phil-passage-id: ch14-p0154 -->
National Academy of Medicine, ["What is AI Psychosis?"](https://nam.edu/news-and-insights/what-is-ai-psychosis/), 2026. Use only as cautious public-facing clinical explanation; do not present "AI psychosis" as a settled diagnosis.
