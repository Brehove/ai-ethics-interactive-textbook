# Creativity, Innovation, and AI: Authorship, Judgment, and the Ethics of Generated Work

<!-- phil-passage-id: ch15-p0001 -->
...
<!-- phil-passage-id: ch15-p0002 -->
The case is useful because every simple reaction misses something. One person sees a striking image and says, "That is art." Another sees a contest entry made with a system other entrants may not have expected and says, "That is unfair." Allen sees his prompting, selection, revision, and editing as creative labor. The [Copyright Office Review Board](https://www.copyright.gov/rulings-filings/review-board/docs/Theatre-Dopera-Spatial.pdf) sees a legal authorship problem: U.S. copyright protection requires human authorship, and the Midjourney-generated expressive content could not be claimed as Allen's human-authored expression without disclaimer. The Office did not say that a human can never make copyrightable work with AI assistance. It said this work, as submitted, still contained AI-generated material that had to be excluded from the copyright claim.

<!-- phil-passage-id: ch15-p0003 -->
...
<!-- phil-passage-id: ch15-p0007 -->
The first philosophical move is to separate the layers of judgment. The [Stanford Encyclopedia of Philosophy entry on creativity](https://plato.stanford.edu/entries/creativity/) notes that philosophers ask about creative products, creative processes, and creative persons. For AI ethics, we need one more layer: creative practices. A practice includes the surrounding tools, data, institutions, audiences, incentives, and responsibilities.

<!-- phil-passage-id: ch15-p0008 -->
<table class="shaded">
  <caption>Four layers for judging AI-assisted creativity and innovation</caption>
  <thead>
    <tr>
  ...
  <tbody>
    <tr>
      ...
      <td>What was made, predicted, designed, or changed, and what standard should it meet?</td>
    </tr>
    <tr>
      <th scope="row">Process</th>
      <td>How was the output produced, selected, revised, checked, or validated?</td>
    </tr>
    <tr>
      <th scope="row">Person or contributor</th>
      <td>Where did human judgment, skill, intention, disclosure, or responsibility appear?</td>
    </tr>
    <tr>
      <th scope="row">Practice</th>
      <td>What kind of creative field does this use help build?</td>
    </tr>
  </tbody>
</table>

<!-- phil-passage-id: ch15-p0009 -->
...
<!-- phil-passage-id: ch15-p0011 -->
**Key Point: The Output Is Not Enough**

<!-- phil-passage-id: ch15-p0012 -->
...
<!-- phil-passage-id: ch15-p0024 -->
Slop also changes the social environment around creative work. In magazine publishing, editors have reported being [overwhelmed by machine-generated submissions](https://nymag.com/intelligencer/article/ai-generated-content-internet-online-slop-spam.html). In online communities, moderators describe a [new burden of deciding whether posts are authentic, fabricated, copied, or AI-reworked](https://www.wired.com/story/ai-slop-is-ruining-reddit-for-everyone/). In book marketplaces, authors and readers worry that [low-quality generated books can crowd search results](https://authorsguild.org/news/ai-driving-new-surge-of-sham-books-on-amazon/), borrow the credibility of real authors, or mislead buyers who assume a human expert stands behind the work. The Authors Guild is a stakeholder advocacy source rather than a neutral measurement of the whole marketplace, but the concern is still ethically important because writers, publishers, booksellers, and readers are among the people who bear the costs of synthetic flooding.

<!-- phil-passage-id: ch15-p0025 -->
The [Amazon KDP disclosure policy](https://kdp.amazon.com/en_US/help/topic/G200672390) shows how platforms are beginning to separate AI-generated and AI-assisted work. Amazon asks publishers to disclose AI-generated text, images, or translations. It distinguishes those cases from AI-assisted brainstorming, editing, refinement, or error-checking where the human created the underlying content. That distinction is imperfect, but it shows the policy problem. A platform needs more than a yes-or-no AI label. It needs a way to ask how much of the finished material came from the system, how much human review occurred, and whether the reader is being misled about expertise, quality, or authorship.

<!-- phil-passage-id: ch15-p0026 -->
Language and idea homogenization are related risks. [Research by Anderson, Shah, and Kreminski](https://arxiv.org/abs/2402.01536) found that, in a 36-participant comparative study, people using ChatGPT for creative ideation produced ideas that were less semantically distinct from one another than people using an alternative creativity-support tool. The same study found that ChatGPT users generated more detailed ideas and felt less responsible for them. That does not prove that AI always makes creativity homogeneous. Other work, such as Ashkinaze and colleagues' [large dynamic experiment on AI ideas](https://arxiv.org/abs/2401.13481), found a more complicated pattern: high exposure to AI-generated examples increased collective idea diversity without improving individual creativity. The evidence is still developing. The cautious conclusion is enough for this chapter: common AI systems can shape the pattern pool from which many people draw, and that can affect voice, variety, responsibility, and the norms of a field.

<!-- phil-passage-id: ch15-p0027 -->
...
<!-- phil-section-id: ch15-s003 -->
## What Kind of Creativity Is Happening?

<!-- phil-passage-id: ch15-p0031 -->
...
<!-- phil-passage-id: ch15-p0041 -->
**Pause: Boden Classifies the Process**

<!-- phil-passage-id: ch15-p0042 -->
...
<!-- phil-section-id: ch15-s004 -->
## Creativity, Value, Skill, and Judgment

<!-- phil-passage-id: ch15-p0044 -->
...
<!-- phil-passage-id: ch15-p0055 -->
<aside class="textbox examples textbox--worked-argument" aria-labelledby="argument-novelty-not-enough">
  <h3 id="argument-novelty-not-enough">Argument Template: Novelty Is Not Enough</h3>
  <p><strong>P1.</strong> Creativity normally requires more than something new-looking; it also requires value, judgment, agency, skill, or achievement in a relevant practice.</p>
  <p><strong>P2.</strong> Generative AI can produce new-looking material at scale without guaranteeing value, judgment, agency, skill, disclosure, or responsibility.</p>
  <p><strong>C.</strong> Therefore, AI-assisted creativity should be judged by the practice that produced and used the output, not by novelty alone.</p>
</aside>

<!-- phil-passage-id: ch15-p0056 -->
...
<!-- phil-section-id: ch15-s005 -->
## Human Judgment Is More Than Tool Use

<!-- phil-passage-id: ch15-p0057 -->
...
<!-- phil-passage-id: ch15-p0065 -->
**Caution: "Tool" Is Too Broad**

<!-- phil-passage-id: ch15-p0066 -->
...
<!-- phil-section-id: ch15-s006 -->
## The Labor Behind the Output

<!-- phil-passage-id: ch15-p0070 -->
...
<!-- phil-passage-id: ch15-p0071 -->
[Trystan Goetze's argument about AI art and labor](https://arxiv.org/abs/2401.06178) treats artist objections as philosophical claims with reasons that can be reconstructed and tested. The objection is roughly this: some AI image systems extract value from artists' work by using their labor to train models, then produce outputs that can compete for attention, commissions, and market opportunities against those same artists. The problem reaches beyond the user's prompt. It concerns the social relation between prior creative labor, model training, platform profit, and downstream competition.

<!-- phil-passage-id: ch15-p0072 -->
Put as an argument, the objection looks like this:

<!-- phil-passage-id: ch15-p0073 -->
<aside class="textbox examples textbox--worked-argument" aria-labelledby="argument-creative-labor-objection">
  <h3 id="argument-creative-labor-objection">Argument Template: The Creative-Labor Objection</h3>
  <p><strong>1.</strong> Creative workers produce images, text, music, code, performances, and other works through skill, time, training, and judgment.</p>
  <p><strong>2.</strong> Generative AI systems can use large collections of such work to produce outputs that imitate, compete with, or substitute for human creative labor.</p>
  <p><strong>3.</strong> If that use occurs without adequate consent, compensation, credit, or accountability, the system benefits from creative labor while shifting value away from the people who helped make the system useful.</p>
  <p><strong>4.</strong> Therefore, some AI-assisted creative practices can be ethically exploitative even when a particular output looks new.</p>
</aside>

<!-- phil-passage-id: ch15-p0074 -->
...
<!-- phil-passage-id: ch15-p0078 -->
[Micaela Mantegna's work](https://yalelawjournal.org/essay/artificial-why-copyright-is-not-the-right-policy-tool-to-deal-with-generative-ai) helps explain why copyright law alone cannot carry all of these ethical concerns. Copyright is important. It shapes what can be protected, licensed, infringed, registered, or defended in court. But copyright does not map perfectly onto fairness. Mantegna argues that generative AI raises concerns about consent, attribution, compensation, labor displacement, and the broader ethics of AI development, while copyright doctrine is a blunt and sometimes distorting policy tool for those concerns.

<!-- phil-passage-id: ch15-p0079 -->
...
<!-- phil-passage-id: ch15-p0080 -->
The [U.S. Copyright Office's AI materials](https://www.copyright.gov/ai/) help separate questions that often get tangled. Output copyrightability asks whether a finished work contains protectable human-authored expression. In the [*Théâtre D'opéra Spatial* case](https://www.copyright.gov/rulings-filings/review-board/docs/Theatre-Dopera-Spatial.pdf), the Office refused registration as submitted because Allen would not disclaim the AI-generated material. Human contribution may have existed, especially in selection and later editing. The Office still declined to treat the Midjourney-generated expressive material as human-authored material Allen could register without disclaimer. The 2025 D.C. Circuit decision in [*Thaler v. Perlmutter*](https://media.cadc.uscourts.gov/opinions/docs/2025/03/23-5233.pdf) also reinforces the current legal baseline that U.S. copyright authorship requires a human author.

<!-- phil-passage-id: ch15-p0081 -->
Training-data fairness asks a different question: whether using copyrighted works to train AI systems is lawful and fair. The Copyright Office's [Part 3 pre-publication report on generative AI training](https://www.copyright.gov/ai/Copyright-and-Artificial-Intelligence-Part-3-Generative-AI-Training-Report-Pre-Publication-Version.pdf) treats training as a fact-specific issue rather than automatically permitted or automatically forbidden. The report also warns against treating creative works as mere neutral data; copyrighted works embody protected human expression even when they become part of a dataset.

<!-- phil-passage-id: ch15-p0082 -->
Recent cases show why details matter. [*Thomson Reuters v. Ross Intelligence*](https://www.ded.uscourts.gov/sites/ded/files/opinions/20-613_5.pdf) involved legal-research materials and a competitor's AI-assisted legal search tool, not a general-purpose image or chatbot model. [*Bartz v. Anthropic*](https://copyrightalliance.org/wp-content/uploads/2025/06/Bartz-v.-Anthropic-Order.pdf) produced a mixed June 2025 ruling: the court treated training on lawfully acquired books differently from claims involving pirated copies and retained libraries. According to [Reuters reporting in May 2026](https://www.reuters.com/legal/government/us-judge-considers-anthropics-15-billion-settlement-authors-lawsuit-2026-05-14/), a proposed $1.5 billion settlement of the authors' claims was still under judicial review and had not yet received final approval. [*Kadrey v. Meta*](https://law.justia.com/cases/federal/district-courts/california/candce/3%3A2023cv03417/415175/598/) granted Meta summary judgment on the record before that court, but the opinion itself warned against reading the decision as a general rule that using copyrighted works to train language models is lawful in all cases.

<!-- phil-passage-id: ch15-p0083 -->
...
<!-- phil-section-id: ch15-s007 -->
## Innovation Is More Than New Stuff

<!-- phil-passage-id: ch15-p0087 -->
...
<!-- phil-passage-id: ch15-p0088 -->
[AlphaFold](https://deepmind.google/science/alphafold/) gives us a strong positive case. Proteins are made from chains of amino acids, and their three-dimensional structures affect what they do in living systems. For decades, predicting protein structures from amino acid sequences was one of biology's hardest computational problems. In 2024, the [Nobel Prize in Chemistry](https://www.nobelprize.org/prizes/chemistry/2024/press-release/) was awarded partly to Demis Hassabis and John Jumper for developing an AI model for protein structure prediction, and partly to David Baker for computational protein design. The [AlphaFold Protein Structure Database](https://alphafold.ebi.ac.uk/), developed with EMBL-EBI, provides open access to predictions for over 200 million protein structures.

<!-- phil-passage-id: ch15-p0089 -->
The mechanism matters. AlphaFold does not look at a protein through a microscope. It starts from the protein's amino-acid sequence, then uses related biological information, including aligned sequences from evolutionarily related proteins, to infer which parts of the chain are likely to be near each other in three-dimensional space. In the [AlphaFold Nature paper](https://www.nature.com/articles/s41586-021-03819-2), the system is described as predicting three-dimensional atomic coordinates from the primary sequence and homologous sequence alignments. Its architecture represents multiple sequence alignments and pairwise residue relationships, updates those representations, and produces structure predictions with confidence estimates.

<!-- phil-passage-id: ch15-p0090 -->
...
<!-- phil-passage-id: ch15-p0098 -->
**Key Point: Prediction Is Not Understanding**

<!-- phil-passage-id: ch15-p0099 -->
...
<!-- phil-passage-id: ch15-p0106 -->
<aside class="textbox shaded" role="note" aria-labelledby="framework-responsible-innovation">
  <h3 id="framework-responsible-innovation">Framework Map: Responsible Innovation</h3>
  <p><strong>Anticipate:</strong> What could this AI use make easier, harder, better, worse, or more common?</p>
  <p><strong>Include:</strong> Who is affected, and whose perspective would change the design or use?</p>
  <p><strong>Reflect:</strong> What values and assumptions are steering the work?</p>
  <p><strong>Respond:</strong> What will change if the tool misleads, harms, excludes, exploits, or degrades the field?</p>
</aside>

<!-- phil-passage-id: ch15-p0107 -->
Responsible innovation connects directly to building like a philosopher. A philosopher asks what assumptions a tool carries, what kind of human practice it forms, who gets power, who loses visibility, what objections matter, and what would count as responsible revision. In design terms, this resembles the broader [philosophy-of-technology](https://plato.stanford.edu/entries/technology/) claim that technologies shape possibilities, roles, values, and institutions.

<!-- phil-passage-id: ch15-p0108 -->
...
<!-- phil-passage-id: ch15-p0110 -->
Consider several examples.

<!-- phil-passage-id: ch15-p0111 -->
...
<!-- phil-section-id: ch15-s009 -->
## A Creativity and Innovation Judgment Audit

<!-- phil-passage-id: ch15-p0117 -->
...
<!-- phil-passage-id: ch15-p0124 -->
<aside class="textbox exercises" aria-labelledby="try-it-creativity-innovation-audit">
  <h3 id="try-it-creativity-innovation-audit">Try It: Creativity and Innovation Audit</h3>
  <p>For one documented case, write one sentence for each part of the audit: practice and field standard, process type, visible human judgment, prior labor, affected people and trust, field-level effects, and responsibility when something goes wrong. Keep the answer concrete enough that another person could check your reasoning.</p>
</aside>

<!-- phil-passage-id: ch15-p0125 -->
...
<!-- phil-passage-id: ch15-p0127 -->
- AlphaFold Protein Structure Database. [AlphaFold DB](https://alphafold.ebi.ac.uk/). Used for the open-access protein-structure prediction database and the scale of available predictions.
- Amazon Kindle Direct Publishing. [Content Guidelines](https://kdp.amazon.com/en_US/help/topic/G200672390). Used for Amazon's distinction between AI-generated and AI-assisted content.
- Anderson, Barrett R., Jash Hemant Shah, and Max Kreminski. ["Homogenization Effects of Large Language Models on Human Creative Ideation"](https://arxiv.org/abs/2402.01536). Used for cautious discussion of LLM-assisted ideation and semantic similarity.
- AP News. ["Judge approves $1.5 billion copyright settlement between AI company Anthropic and authors"](https://apnews.com/article/9643064e847a5e88ef6ee8b620b3a44c). Used for background on the proposed Anthropic authors settlement; supplemented with Reuters for 2026 status.
- Ashkinaze, Joshua, Julia Mendelsohn, Li Qiwei, Ceren Budak, and Eric Gilbert. ["How AI Ideas Affect the Creativity, Diversity, and Evolution of Human Ideas"](https://arxiv.org/abs/2401.13481). Used to complicate one-directional homogenization claims.
- Authors Guild. ["AI Is Driving a New Surge of Sham Books on Amazon"](https://authorsguild.org/news/ai-driving-new-surge-of-sham-books-on-amazon/). Used as stakeholder evidence for publishing-market concerns; not treated as a neutral quantitative measure of the entire marketplace.
- *Bartz v. Anthropic*, June 23, 2025 order. [Copyright Alliance copy](https://copyrightalliance.org/wp-content/uploads/2025/06/Bartz-v.-Anthropic-Order.pdf). Used for the mixed fair-use/pirated-copy ruling.
- Boden, Margaret. ["Creativity and Artificial Intelligence"](https://doi.org/10.1016/S0004-3702(98)00055-1). *Artificial Intelligence* 103 (1998). Used for computational creativity and the process-oriented creativity framework.
- Boden, Margaret. [*The Creative Mind: Myths and Mechanisms*](https://www.routledge.com/The-Creative-Mind-Myths-and-Mechanisms/Boden/p/book/9780415314534). 2nd ed., Routledge, 2004. Used for the broader creativity framework, including combinatorial, exploratory, and transformational creativity.
- Commonwealth Foundation. ["2026 Commonwealth Short Story Prize Update"](https://commonwealthfoundation.com/2026-cw-prize-update/). Used as a process-evidence case involving AI allegations, detector limits, drafts, notes, and review procedures.
- DeepMind. [AlphaFold](https://deepmind.google/science/alphafold/). Used for accessible background on AlphaFold and protein-structure prediction.
- Gaut, Berys. ["The Philosophy of Creativity"](https://doi.org/10.1111/j.1747-9991.2010.00351.x). *Philosophy Compass* 5.12 (2010). Used for creativity beyond art, originality, value, agency, skill, and judgment.
- Goetze, Trystan S. ["AI Art is Theft: Labour, Extraction, and Exploitation"](https://arxiv.org/abs/2401.06178). Used for the creative-labor and extraction objection.
- Guardian. ["Spam, junk ... slop? The latest wave of AI behind the zombie internet"](https://www.theguardian.com/technology/article/2024/may/19/spam-junk-slop-the-latest-wave-of-ai-behind-the-zombie-internet). Used for the public term "AI slop" and platform-scale synthetic-content concern.
- Internet Encyclopedia of Philosophy. ["Artificial Intelligence"](https://iep.utm.edu/artificial-intelligence/). Used for accessible background on Searle's Chinese Room and intentionality questions.
- Jumper, John et al. ["Highly accurate protein structure prediction with AlphaFold"](https://www.nature.com/articles/s41586-021-03819-2). *Nature* 596 (2021). Used for the AlphaFold mechanism and confidence-estimation discussion.
- *Kadrey v. Meta*, June 25, 2025 order. [Justia copy](https://law.justia.com/cases/federal/district-courts/california/candce/3%3A2023cv03417/415175/598/). Used for record-specific fair-use discussion and caution against overgeneralizing one ruling.
- Mantegna, Micaela. ["ARTificial: Why Copyright Is Not the Right Policy Tool to Deal with Generative AI"](https://yalelawjournal.org/essay/artificial-why-copyright-is-not-the-right-policy-tool-to-deal-with-generative-ai). *Yale Law Journal Forum*. Used for the claim that copyright cannot carry all generative-AI fairness, labor, consent, and compensation issues.
- New York Magazine / Intelligencer. ["The Internet Is Filling Up Because Nobody Wants to Pay Humans"](https://nymag.com/intelligencer/article/ai-generated-content-internet-online-slop-spam.html). Used for reporting on machine-generated submissions and online slop.
- Nobel Prize. ["The Nobel Prize in Chemistry 2024"](https://www.nobelprize.org/prizes/chemistry/2024/press-release/). Used for the Nobel award division among David Baker, Demis Hassabis, and John Jumper.
- Reuters. ["US judge considers Anthropic's $1.5 billion settlement of authors' lawsuit"](https://www.reuters.com/legal/government/us-judge-considers-anthropics-15-billion-settlement-authors-lawsuit-2026-05-14/). Used for May 2026 status of the proposed Anthropic settlement and the note that final approval had not yet been granted at that hearing.
- Reuters Institute. ["AI-generated slop is quietly conquering the internet"](https://reutersinstitute.politics.ox.ac.uk/news/ai-generated-slop-quietly-conquering-internet-it-threat-journalism-or-problem-will-fix-itself). Used as additional background on slop and journalism/platform concerns.
- Searle, John. "Minds, Brains, and Programs." *Behavioral and Brain Sciences* 3.3 (1980). Used through the IEP background source for the Chinese Room and symbol-manipulation argument.
- Stanford Encyclopedia of Philosophy. ["Creativity"](https://plato.stanford.edu/entries/creativity/). Used for product/process/person distinctions, P-creativity/H-creativity, Boden's framework, novelty, value, originality, agency, and process conditions.
- Stanford Encyclopedia of Philosophy. ["Intellectual Property"](https://plato.stanford.edu/entries/intellectual-property/). Used for background on intellectual-property concepts and philosophical issues.
- Stanford Encyclopedia of Philosophy. ["Philosophy of Technology"](https://plato.stanford.edu/entries/technology/). Used for technology as value-laden practice and responsible design context.
- Stanford Encyclopedia of Philosophy. ["Scientific Discovery"](https://plato.stanford.edu/entries/scientific-discovery/). Used for scientific discovery as a practice involving models, instruments, data, institutions, interpretation, and validation.
- Stilgoe, Jack, Richard Owen, and Phil Macnaghten. ["Developing a framework for responsible innovation"](https://www.sciencedirect.com/science/article/pii/S0048733313000930). *Research Policy* 42.9 (2013). Used for anticipation, inclusion, reflexivity, and responsiveness.
- *Thaler v. Perlmutter*, D.C. Circuit, March 18, 2025. [Opinion PDF](https://media.cadc.uscourts.gov/opinions/docs/2025/03/23-5233.pdf). Used for current U.S. human-authorship baseline.
- *Thomson Reuters v. Ross Intelligence*, February 11, 2025 opinion. [District of Delaware PDF](https://www.ded.uscourts.gov/sites/ded/files/opinions/20-613_5.pdf). Used as one fact-specific AI/copyright fair-use case involving legal research materials.
- U.S. Copyright Office. [Copyright and Artificial Intelligence](https://www.copyright.gov/ai/). Used for official AI/copyright report context.
- U.S. Copyright Office. ["Copyright and Artificial Intelligence, Part 2: Copyrightability"](https://www.copyright.gov/ai/Copyright-and-Artificial-Intelligence-Part-2-Copyrightability-Report.pdf). Used for human authorship, AI-assisted works, selection/arrangement/editing, and prompting/control analysis.
- U.S. Copyright Office. ["Copyright and Artificial Intelligence, Part 3: Generative AI Training"](https://www.copyright.gov/ai/Copyright-and-Artificial-Intelligence-Part-3-Generative-AI-Training-Report-Pre-Publication-Version.pdf). Used for training-data analysis, fair-use uncertainty, licensing/consent questions, and the caution that creative works are not merely neutral data.
- U.S. Copyright Office Review Board. ["Second Request for Reconsideration for Refusal to Register Théâtre D'opéra Spatial"](https://www.copyright.gov/rulings-filings/review-board/docs/Theatre-Dopera-Spatial.pdf). Used for the opening case, 624 prompts/revisions, human edits, AI-generated content disclaimer, and human authorship analysis.
- WIRED. ["AI Slop Is Ruining Reddit for Everyone"](https://www.wired.com/story/ai-slop-is-ruining-reddit-for-everyone/). Used for Reddit moderation and authenticity concerns.

<!-- phil-passage-id: ch15-p0128 -->
