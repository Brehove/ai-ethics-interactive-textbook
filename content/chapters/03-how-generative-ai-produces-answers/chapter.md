...
Once we separate prediction, training, post-training, and the wrapper, familiar failures become easier to explain.
...
- Gladd, J. (2026). [Testing Moral Arguments: Premises, Inferences, Objections, and Revision](/chapter/testing-moral-arguments/). *Ethics and Artificial Intelligence*. Used for PHIL 123's P1/P2/C structure, normative and descriptive premise distinction, and cross-examination methods.
