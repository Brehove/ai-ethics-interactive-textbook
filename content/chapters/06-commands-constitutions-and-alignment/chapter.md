# Commands, Constitutions, and Alignment: Natural Law in the AI Alignment Conversation

<!-- phil-section-id: ch06-s001 -->
...
<!-- phil-passage-id: ch06-p0003 -->
A company had written a constitution for a piece of software. The stranger detail appeared near the end of the document, in the acknowledgments. Anthropic identified outside commenters who provided "detailed feedback or discussion" during the Constitution's creation. The list included [Brian Green](https://scholarcommons.scu.edu/markkula/13/), an ethicist whose published work includes Catholic natural-law ethics, Father Brendan McGuire, and Bishop Paul Tighe. [Brian Roewe reports](https://www.ncronline.org/news/why-ai-company-anthropic-helping-launch-pope-leo-xivs-encyclical) that Tighe coauthored [*Antiqua et nova*](https://www.vatican.va/roman_curia/congregations/cfaith/documents/rc_ddf_doc_20250128_antiqua-et-nova_en.html), a Catholic document about AI and human intelligence.

<!-- phil-passage-id: ch06-p0004 -->
The acknowledgments establish participation. Public reporting supplies more context. Elias Wachtel reports in [*The Atlantic*](https://www.theatlantic.com/ideas/2026/04/silicon-valley-catholicism-ai-leo/686948/) that Anthropic cofounder Chris Olah said Catholic thought had informed some of the company's ethical commitments. Wachtel also reports that three Catholic thinkers gave feedback on the Constitution. A correction appended to the article clarifies their role: Olah and two in-house philosophers worked on the document, while the Catholic thinkers provided feedback. They did not coauthor it.

<!-- phil-passage-id: ch06-p0005 -->
The exchange continued after the document appeared. Brian Roewe reports in the [*National Catholic Reporter*](https://www.ncronline.org/news/why-ai-company-anthropic-helping-launch-pope-leo-xivs-encyclical) that Anthropic held meetings with religious leaders and philosophers and asked for feedback about ethics and morals in Claude's development. On May 25, Olah spoke at the Vatican presentation of Pope Leo XIV's AI encyclical, [*Magnifica Humanitas*](https://www.vatican.va/content/leo-xiv/en/encyclicals/documents/20260515-magnifica-humanitas.html). [Anthropic described his appearance](https://www.anthropic.com/news/chris-olah-pope-leo-encyclical) as part of an effort to widen the AI conversation. Olah argued that questions about character, human flourishing, and the social effects of AI exceed the expertise of computer scientists. In his [response at the event](https://press.vatican.va/content/salastampa/en/bollettino/pubblico/2026/05/25/260525g.html), Pope Leo accepted Olah's invitation to continue listening and speaking together. The encyclical's 107th paragraph argues that aligning AI with "human values" remains inadequate when the ethical framework defining those values escapes public scrutiny.

<!-- phil-passage-id: ch06-p0006 -->
...
<h3 id="callout-command-good-test">Key Point: Operational Authority and Moral Authority</h3>
<p>Anthropic can make a principle govern Claude's behavior. Moral authority requires a further argument about the human good that principle protects. Consultation with Catholic moral thinkers, including a natural-law scholar, may improve that argument, but the consultation does not establish that the principle is correct.</p>
</aside>

<!-- phil-passage-id: ch06-p0019 -->
Natural law adds a more substantive question. [Aquinas understands law](https://www.newadvent.org/summa/2091.htm) as an ordering of action toward goods that human reason can recognize. His account begins with a view of the human person and of flourishing. Philosophers sometimes call this a **moral anthropology**: an account of what human beings are, which goods help them flourish, and which conditions damage their ability to live well. His [discussion of natural-law precepts](https://www.newadvent.org/summa/2094.htm) connects practical reasoning with goods such as life, knowledge, rational conduct, and social life. Later natural-law traditions develop these goods through ideas such as dignity, participation, and the common good, while disagreeing about how particular cases should be judged.

<!-- phil-passage-id: ch06-p0020 -->
...
<h3 id="callout-grounding-method">Framework Map: Grounding Versus Method</h3>
<dl>
<dt><strong>Grounding</strong></dt>
<dd>The question of what makes a moral claim true or binding. Natural law, for example, grounds moral claims in a rational order of human goods.</dd>
<dt><strong>Method</strong></dt>
<dd>The question of how a reasoner moves from moral standards and case facts toward a judgment. Different frameworks may attend to some of the same features while grounding and connecting them differently.</dd>
</dl>
<p>A natural-law reasoner can consider character, duties, dignity, stakeholders, and effects. Those considerations must still be connected to the goods and principles that carry the natural-law argument. Similar vocabulary does not erase disagreement among frameworks.</p>
</aside>

<!-- phil-passage-id: ch06-p0026 -->
...
<!-- phil-passage-id: ch06-p0031 -->
Anthropic's later work on [Collective Constitutional AI](https://www.anthropic.com/news/collective-constitutional-ai-aligning-a-language-model-with-public-input), done with the Collective Intelligence Project, explores how public input can influence model behavior. The team gathered principles from a public sample and used them to train a model, then compared that model to one trained on the standard set of principles. Public suggestions had to be translated into forms usable in the training method. Participants disagreed, some proposed principles conflicted, and the research team still chose the thresholds and evaluation procedures. The experiment broadened participation while making those translation decisions visible.

<!-- phil-passage-id: ch06-p0032 -->
<aside class="textbox shaded textbox--key-point" role="note" aria-labelledby="callout-alignment-not-end">
<h3 id="callout-alignment-not-end">Key Point: Alignment Is Not the End of Ethics</h3>
<p>Alignment asks whether a system follows a chosen target. Ethical judgment asks whether the target is morally defensible, who chose it, who can challenge it, and who bears responsibility when it fails. A perfectly aligned system can still be aligned to the wrong things. Getting the technical question right does not close the moral one.</p>
</aside>

<!-- phil-passage-id: ch06-p0033 -->
...
<!-- phil-passage-id: ch06-p0037 -->
<aside class="textbox shaded textbox--caution" role="note" aria-labelledby="callout-influence-evidence">
<h3 id="callout-influence-evidence">Caution: Track the Level of Influence</h3>
<dl>
<dt><strong>Documented</strong></dt>
<dd>Catholic thinkers provided detailed feedback or discussion on Claude's Constitution.</dd>
<dt><strong>Reported</strong></dt>
<dd>Chris Olah said Catholic thought informed some Anthropic ethical commitments.</dd>
<dt><strong>Not established publicly</strong></dt>
<dd>Which clauses changed because of that feedback, whether Anthropic adopted a natural-law foundation, or how much authority the advisers held over the final document.</dd>
</dl>
</aside>

<!-- phil-passage-id: ch06-p0038 -->
...
<!-- phil-passage-id: ch06-p0040 -->
Anthropic's [Collective Constitutional AI](https://www.anthropic.com/news/collective-constitutional-ai-aligning-a-language-model-with-public-input) shows a second attempt to widen participation. Members of the public proposed principles, while the research team chose the sample, translated suggestions into usable language, resolved conflicts, and decided how the model would be evaluated. The experiment made public input part of the process while leaving implementation and final judgment with the developers.

<!-- phil-passage-id: ch06-p0041 -->
The same problem appears in religious consultation. The advisers may sharpen Anthropic's understanding of dignity, formation, agency, and the common good. Anthropic can accept, modify, or reject what it hears. Kevin Lee's ["Where Computation Halts"](https://kevinlee322.substack.com/p/magnifica-humanitas-and-the-return) argues that AI governance needs a richer account of the human person than labs can supply alone. Abi Awomosu's ["Vatican Washing"](https://abiawomosu.substack.com/p/vatican-washing-why-all-the-tech) raises the opposing concern that religious dialogue can lend moral credibility to a company while leaving its power intact. The public evidence cannot settle which description best fits every interaction. It gives us standards for asking what changed, who decided, and who remains accountable.

<!-- phil-passage-id: ch06-p0042 -->
...
<!-- phil-passage-id: ch06-p0049 -->
In late 2025, Richard Weiss [reported reconstructing an apparent training document from Claude Opus 4.5 and called it the "soul document"](https://www.lesswrong.com/posts/vpNG99GhbBoLov9og/claude-4-5-opus-soul-document). Weiss cautioned that his reconstruction was "fuzzy" and might not match the original document exactly. Anthropic's Amanda Askell later confirmed that an underlying document had been used in supervised training, not that every sentence in Weiss's reconstruction was exact. Simon Willison covered the reconstruction and its relationship to the later Constitution on [his blog](https://simonwillison.net/2026/Jan/21/claudes-new-constitution/). The apparent document described what Anthropic hoped Claude would be like in unusually personal language, which prompted arguments about whether the company was crossing into personhood language.

<!-- phil-passage-id: ch06-p0050 -->
...
<h3 id="callout-corporate-not-natural-law">Caution: A Corporate Constitution Is Not Natural Law</h3>
<p>Anthropic's constitution is an institutional governance artifact. It uses moral vocabulary, shapes model behavior through training, and remains institutionally revisable. Treating its corporate authorship as moral proof would confuse operational force with moral justification. The authority analogy exposes that explanatory fork without treating corporate governance as an instance of divine command theory.</p>
</aside>

<!-- phil-section-id: ch06-s007 -->
## Pope Leo's Challenge From Inside the Conversation

<!-- phil-passage-id: ch06-p0053 -->
...
<!-- phil-section-id: ch06-s008 -->
## Audit the Alignment Conversation

<!-- phil-passage-id: ch06-p0058 -->
...
<!-- phil-passage-id: ch06-p0059 -->
<aside class="textbox exercises" aria-labelledby="callout-authority-map">
<h3 id="callout-authority-map">Try It: Audit the Alignment Conversation</h3>
<p>Choose one principle from Claude's Constitution. Use the Constitution, its acknowledgments, and one source from this chapter. Answer each item in short phrases or one or two complete sentences.</p>
<ul>
<li><strong>The principle:</strong> State the specific principle in your own words and link to its location.</li>
<li><strong>The human good:</strong> Identify the good the principle appears to protect, such as agency, truth, safety, relationship, dignity, or participation.</li>
<li><strong>The author and advisers:</strong> Distinguish who wrote and controls the document from people who provided feedback.</li>
<li><strong>The documented connection:</strong> State what the evidence establishes about outside participation.</li>
<li><strong>The inference:</strong> Identify any connection you suspect but cannot document, such as the source of a particular phrase.</li>
<li><strong>The natural-law question:</strong> Explain what account of human nature or flourishing would support or challenge the principle.</li>
<li><strong>Control and revision:</strong> Identify who interprets, implements, and may revise the principle.</li>
<li><strong>Contestability:</strong> Explain how a user, adviser, or affected group could challenge its application.</li>
<li><strong>Provisional verdict:</strong> Decide whether the consultation strengthens the principle's justification, its legitimacy, both, or neither. State what evidence limits your conclusion.</li>
</ul>
</aside>

<!-- phil-passage-id: ch06-p0060 -->
...
<!-- phil-passage-id: ch06-p0065 -->
<aside class="textbox shaded textbox--argument-template" role="note" aria-labelledby="callout-authority-argument">
<h3 id="callout-authority-argument">Argument Template: Does Consultation Strengthen Legitimacy?</h3>
<dl>
<dt><strong>N1: Normative standard</strong></dt>
<dd>Consultation strengthens the legitimacy of an AI-governance document when it introduces a defensible account of human goods, can influence decisions, and leaves authority and accountability visible.</dd>
<dt><strong>F1: Case fact</strong></dt>
<dd>Anthropic sought detailed feedback from Catholic thinkers and continued public dialogue with Catholic institutions. Anthropic retained final control over Claude's Constitution, and the public evidence does not establish which clauses changed because of that input.</dd>
<dt><strong>B1: Bridge</strong></dt>
<dd>The consultation created an opportunity for a developed account of human flourishing to influence Anthropic. The public evidence does not establish which natural-law claims entered the company's decisions, and Anthropic retained final control.</dd>
<dt><strong>C: Conclusion</strong></dt>
<dd>Catholic participation strengthened the moral scrutiny surrounding Claude's Constitution, but it did not make the Constitution a natural-law document or settle its institutional legitimacy.</dd>
</dl>
</aside>

<!-- phil-passage-id: ch06-p0066 -->
...
<!-- phil-section-id: ch06-s010 -->
## Where This Leaves You

<!-- phil-passage-id: ch06-p0069 -->
...
<!-- phil-section-id: ch06-s011 -->
## References

<!-- phil-section-id: ch06-s012 -->
### Primary AI Governance Sources

<!-- phil-passage-id: ch06-p0073 -->
- Anthropic. ["Claude's Constitution."](https://www.anthropic.com/constitution) January 22, 2026.
- Anthropic. ["Claude's new constitution."](https://www.anthropic.com/news/claude-new-constitution) January 22, 2026.
- Anthropic. ["Constitutional AI: Harmlessness from AI Feedback."](https://www.anthropic.com/research/constitutional-ai-harmlessness-from-ai-feedback) December 15, 2022.
- Anthropic and the Collective Intelligence Project. ["Collective Constitutional AI: Aligning a Language Model with Public Input."](https://www.anthropic.com/news/collective-constitutional-ai-aligning-a-language-model-with-public-input) October 17, 2023.
- Anthropic. ["Claude's Character."](https://www.anthropic.com/research/claude-character) June 8, 2024.
- Anthropic. ["Exploring model welfare."](https://www.anthropic.com/research/exploring-model-welfare) April 24, 2025.
- Olah, Christopher. ["Anthropic co-founder Chris Olah's remarks on Pope Leo XIV's encyclical 'Magnifica humanitas.'"](https://www.anthropic.com/news/chris-olah-pope-leo-encyclical) Anthropic. May 25, 2026.

<!-- phil-section-id: ch06-s013 -->
### Religious and Institutional Sources

<!-- phil-passage-id: ch06-p0074 -->
- Pope Leo XIV. [*Magnifica Humanitas: On Safeguarding the Human Person in the Time of Artificial Intelligence.*](https://www.vatican.va/content/leo-xiv/en/encyclicals/documents/20260515-magnifica-humanitas.html) May 15, 2026.
- Holy See Press Office. ["Presentation of the Encyclical Letter 'Magnifica Humanitas' of Pope Leo XIV, on Safeguarding the Human Person in the Time of Artificial Intelligence."](https://press.vatican.va/content/salastampa/en/bollettino/pubblico/2026/05/25/260525g.html) May 25, 2026.
- Dicastery for the Doctrine of the Faith and Dicastery for Culture and Education. [*Antiqua et nova: Note on the Relationship Between Artificial Intelligence and Human Intelligence.*](https://www.vatican.va/roman_curia/congregations/cfaith/documents/rc_ddf_doc_20250128_antiqua-et-nova_en.html) January 28, 2025.

<!-- phil-section-id: ch06-s014 -->
### Philosophical Sources

<!-- phil-passage-id: ch06-p0075 -->
- Austin, Michael W. ["Divine Command Theory."](https://iep.utm.edu/divine-command-theory/) *Internet Encyclopedia of Philosophy*.
- Aquinas, Thomas. [*Summa Theologiae*, I-II, Question 91: "The Various Kinds of Law."](https://www.newadvent.org/summa/2091.htm)
- Aquinas, Thomas. [*Summa Theologiae*, I-II, Question 94: "The Natural Law."](https://www.newadvent.org/summa/2094.htm)
- Green, Brian Patrick. ["Transhumanism and Catholic Natural Law: Changing Human Nature and Changing Moral Norms?"](https://scholarcommons.scu.edu/markkula/13/) In *Religion and Transhumanism: The Unknown Future of Human Enhancement*, edited by Calvin Mercer and Tracy J. Trothen. Praeger, 2014.

<!-- phil-section-id: ch06-s015 -->
### Public Commentary and Bridge Sources

<!-- phil-passage-id: ch06-p0076 -->
- Wachtel, Elias. ["Why Silicon Valley Is Turning to the Catholic Church."](https://www.theatlantic.com/ideas/2026/04/silicon-valley-catholicism-ai-leo/686948/) *The Atlantic*. April 25, 2026; updated April 28, 2026.
- Roewe, Brian. ["Why is AI company Anthropic helping launch Pope Leo XIV's encyclical?"](https://www.ncronline.org/news/why-ai-company-anthropic-helping-launch-pope-leo-xivs-encyclical) *National Catholic Reporter*. May 22, 2026.
- Lee, Kevin. ["Where Computation Halts: Magnifica Humanitas and the Politics of the Incompressible Person."](https://kevinlee322.substack.com/p/magnifica-humanitas-and-the-return) May 21, 2026.
- Awomosu, Abi. ["Vatican Washing: Why Every Tech Broligarch's Road Now Lead to Rome."](https://abiawomosu.substack.com/p/vatican-washing-why-all-the-tech) May 27, 2026.
- Willison, Simon. ["Claude's new constitution."](https://simonwillison.net/2026/Jan/21/claudes-new-constitution/) January 21, 2026.
- Weiss, Richard. ["Claude 4.5 Opus' Soul Document."](https://www.lesswrong.com/posts/vpNG99GhbBoLov9og/claude-4-5-opus-soul-document) *LessWrong*. November 28, 2025.

<!-- phil-section-id: ch06-s016 -->
...
- Mor, Noa, Omri Abend, Renana Keydar, and Yuval Shany. ["Claude's New Constitution: Two Evaluative Continua."](https://www.oxford-aiethics.ox.ac.uk/blog/claudes-new-constitution-two-evaluative-continua) *AI Ethics at Oxford Blog*. March 13, 2026.
