...
<!-- phil-section-id: ch17-s002 -->
<h3 id="core-concepts">Concept Map: Accelerationism As A Design Lens</h3>
<!-- phil-passage-id: ch17-p0013 -->
<dl>
<dt><strong>Acceleration</strong></dt><dd>Increasing the speed, scale, autonomy, or feedback intensity of a process. <strong>Design question:</strong> What exactly becomes faster, cheaper, easier, more scalable, or more autonomous?</dd>
<dt><strong>Friction</strong></dt><dd>A delay, obstacle, review step, skill requirement, social process, or institutional check. <strong>Design question:</strong> Is this friction needless drag, or does it protect judgment, consent, care, skill, or accountability?</dd>
<dt><strong>Feedback loop</strong></dt><dd>A system whose outputs become inputs for future behavior. <strong>Design question:</strong> What does the system learn from, reward, amplify, or normalize?</dd>
<dt><strong>Delegation</strong></dt><dd>Moving action or judgment from a person to a tool, model, platform, or institution. <strong>Design question:</strong> What remains under human responsibility, review, and appeal?</dd>
<dt><strong>Deterritorialization</strong></dt><dd>Loosening or breaking apart an older arrangement, boundary, or practice. <strong>Design question:</strong> What older limit, custom, profession, or workflow is being opened up?</dd>
<dt><strong>Reterritorialization</strong></dt><dd>Reorganizing the released activity into a new structure. <strong>Design question:</strong> Who or what captures the new capacity: users, workers, platforms, managers, vendors, states, or markets?</dd>
<dt><strong>Differential development</strong></dt><dd>Accelerating protective capacities while slowing or constraining dangerous capacities. <strong>Design question:</strong> What should move faster, what should slow down, and what safeguard must catch up?</dd>
<dt><strong>Contestability</strong></dt><dd>Affected people can challenge a system's output, evidence, decision, or direction. <strong>Design question:</strong> Who can appeal, refuse, audit, override, or redirect the system?</dd>
</dl>

<!-- phil-passage-id: ch17-p0014 -->
...
<!-- phil-section-id: ch17-s003 -->
## Deep Background: Progress, Apocalypse, Machinery, Feedback

<!-- phil-passage-id: ch17-p0017 -->
Accelerationism does not begin in medieval theology. But some accelerationist rhetoric borrows a structure that older eschatological thinking made familiar: history seems to move toward crisis, disclosure, judgment, and transformation. Augustine's *City of God*, for example, frames history through the two cities, divine judgment, and the last things; in [Book XX](https://www.newadvent.org/fathers/120120.htm), Augustine turns to the last judgment because present history is morally confusing. The wicked may prosper, the righteous may suffer, and the meaning of events is not fully disclosed within ordinary political time.

<!-- phil-passage-id: ch17-p0018 -->
...
<!-- phil-section-id: ch17-s004 -->
## Capital, Desire, Release, And Capture

<!-- phil-passage-id: ch17-p0031 -->
Deleuze and Guattari turn process into a theory of capitalism, desire, and social life. Their work is difficult, and this chapter uses only one limited part of it. The [Stanford Encyclopedia of Philosophy entry on Gilles Deleuze](https://plato.stanford.edu/entries/deleuze/) situates his work with Guattari inside a project concerned with desire, social formations, capitalism, and processes often described through deterritorialization and reterritorialization.

<!-- phil-passage-id: ch17-p0032 -->
...
<!-- phil-section-id: ch17-s005 -->
## CCRU, Nick Land, And The Inhuman Process

<!-- phil-passage-id: ch17-p0038 -->
...
<!-- phil-passage-id: ch17-p0041 -->
> "Earth is captured by a technocapital singularity."

<!-- phil-passage-id: ch17-p0042 -->
...
<!-- phil-passage-id: ch17-p0050 -->
One serious reply to Land also comes from Reza Negarestani's later rationalist and inhumanist project. Negarestani's [*Intelligence and Spirit*](https://www.urbanomic.com/book/intelligence-and-spirit/) connects artificial general intelligence, German Idealism, Kant, Hegel, Plato, and the question of intelligence. His work is difficult, but one classroom-level point is useful: a feedback loop can amplify and stabilize, but it cannot by itself supply the norms by which its outputs should be judged. Outcompeting is not the same as being justified. Winning is not the same as being true or good.

<!-- phil-passage-id: ch17-p0051 -->
...
<!-- phil-passage-id: ch17-p0053 -->
If Land represents the hard right or inhuman version of accelerationist thinking, left accelerationism represents a different answer. The major public text is Nick Srnicek and Alex Williams's [*#ACCELERATE Manifesto for an Accelerationist Politics*](https://criticallegalthinking.com/2013/05/14/accelerate-manifesto-for-an-accelerationist-politics/), published in 2013. The later book [*Inventing the Future: Postcapitalism and a World Without Work*](https://www.versobooks.com/en-gb/products/148-inventing-the-future) develops a related politics of automation, post-work imagination, and institutional strategy.

<!-- phil-passage-id: ch17-p0054 -->
...
<!-- phil-passage-id: ch17-p0061 -->
<aside class="textbox shaded textbox--argument-template" role="note" aria-labelledby="left-acc-template">
<h3 id="left-acc-template">Argument Template: Left Accelerationism</h3>
<p><strong>P1.</strong> Capitalism develops powerful technological capacities but organizes them around profit, ownership, scarcity, and labor discipline.</p>
<p><strong>P2.</strong> Simply resisting or slowing technology can leave those capacities under capitalist control while surrendering the possibility of large-scale emancipatory futures.</p>
<p><strong>C.</strong> The ethical and political task is to reclaim, redesign, and govern technological capacity toward public abundance, worker autonomy, and collective flourishing.</p>
</aside>

<!-- phil-passage-id: ch17-p0062 -->
...
<!-- phil-section-id: ch17-s007 -->
## Broad Acceleration, E/acc, And Techno-Optimism

<!-- phil-passage-id: ch17-p0063 -->
...
<!-- phil-passage-id: ch17-p0069 -->
The e/acc principles post ["Notes on e/acc principles and tenets"](https://beff.substack.com/p/notes-on-eacc-principles-and-tenets), posted by Beff Jezos and bayes in 2022, treats variance, competition, markets, energy, and intelligence as adaptive forces. It begins from a physics-first picture of life as dissipative adaptation, then scales that picture upward into civilization, markets, meta-organisms, and technological growth. In that view, top-down control is suspicious because it reduces exploration. A society learns by trying many things. The future arrives through distributed experimentation, not through a committee deciding in advance which path is safe.

<!-- phil-passage-id: ch17-p0070 -->
The Kardashev scale gives e/acc one of its most concrete images. In Verdon's [Lex Fridman interview](https://lexfridman.com/guillaume-verdon-transcript/), he explains the scale as a measure of energy production and consumption. A Type I civilization uses energy on the scale of the sunlight reaching Earth. A Type II civilization harnesses the output of its star. A Type III civilization operates at the scale of a galaxy. Verdon connects that image to AGI, thermodynamics, civilizational growth, and expansion beyond Earth. The language is theatrical, but the design principle is clear. Growth, energy, intelligence, and adaptation belong together.

<!-- phil-passage-id: ch17-p0071 -->
Elon Musk is not treated here as a formal e/acc theorist. Still, Tesla and SpaceX show why Kardashev-style and accelerationist rhetoric can feel natural in contemporary tech culture. In the [2006 Tesla master plan](https://www.tesla.com/secret-master-plan), Musk describes Tesla's purpose as expediting the transition from a hydrocarbon economy to a solar electric economy, then lays out a staged strategy: start with an expensive sports car, use the money to build cheaper cars, and keep driving down cost and scaling access. In SpaceX's 2017 [Making Life Multiplanetary](https://spacex.relayto.com/e/making-life-multiplanetary-ddvqil46?utm_source=tomegenius) presentation materials, the aim is to make human life multiplanetary and make the future feel larger than the past. These examples do not prove ideological identity. They show family resemblance: energy transition, scale, speed, future-orientation, and civilization-level ambition become product strategy.

<!-- phil-passage-id: ch17-p0072 -->
...
<!-- phil-passage-id: ch17-p0075 -->
<aside class="textbox shaded textbox--argument-template" role="note" aria-labelledby="broad-acc-template">
<h3 id="broad-acc-template">Argument Template: Broad Acceleration</h3>
<p><strong>P1.</strong> Intelligence, energy, and technological capacity expand what humans can do.</p>
<p><strong>P2.</strong> Expanded capacity can reduce suffering, increase abundance, and solve problems that existing institutions cannot solve.</p>
<p><strong>P3.</strong> Delaying beneficial capacity creates opportunity costs, including preventable harms.</p>
<p><strong>C.</strong> We should usually favor faster development, broader experimentation, and less centralized control unless a specific risk justifies the delay.</p>
</aside>

<!-- phil-passage-id: ch17-p0076 -->
...
<!-- phil-section-id: ch17-s008 -->
## The Slowdown Objection

<!-- phil-passage-id: ch17-p0079 -->
...
<!-- phil-passage-id: ch17-p0082 -->
Virtue ethics adds another concern. Speed changes habits. A student who uses AI to avoid every difficult moment may weaken the patience and skill the course was meant to build. A manager who delegates every difficult judgment to a dashboard may become less practiced in seeing workers as whole people. A programmer who accepts agent-generated code without understanding it may accumulate technical debt and lose the ability to judge the system later. Shannon Vallor's chapter ["Virtues in the Digital Age"](https://academic.oup.com/edited-volume/37078), published in Carissa Veliz's *Oxford Handbook of Digital Ethics*, is useful here because digital environments shape habits, attention, judgment, and practical wisdom at large scale and high speed.

<!-- phil-passage-id: ch17-p0083 -->
...
<!-- phil-passage-id: ch17-p0091 -->
<aside class="textbox shaded textbox--caution" role="note" aria-labelledby="friction-caution">
<h3 id="friction-caution">Caution: Friction Is Not Always Failure</h3>
<p>When a product removes friction, ask what kind of friction disappeared. Was it needless delay, or was it review, consent, verification, skill practice, care, accountability, or public contestability? The ethical status of speed depends on that difference.</p>
</aside>

<!-- phil-section-id: ch17-s009 -->
## Differential Acceleration: Not One Speed For Everything

<!-- phil-passage-id: ch17-p0092 -->
Nick Bostrom gives the cleanest bridge between the existential-risk chapter and accelerationism. In ["The Vulnerable World Hypothesis"](https://nickbostrom.com/papers/vulnerable.pdf), Bostrom states the principle of differential technological development: societies should try to slow the development of dangerous and harmful technologies, especially those that raise existential risk, while accelerating beneficial technologies, especially those that reduce existential risk. This changes the structure of the question.

<!-- phil-passage-id: ch17-p0093 -->
...
<!-- phil-passage-id: ch17-p0095 -->
This frame gives students a better design question:

<!-- phil-passage-id: ch17-p0096 -->
<aside class="textbox shaded textbox--framework-map" role="note" aria-labelledby="three-acceleration-positions">
<h3 id="three-acceleration-positions">Framework Map: Three Acceleration Positions</h3>
<dl>
<dt><strong>Broad acceleration</strong></dt>
<dd>Favor speed, experimentation, intelligence, energy, markets, and variance because delay has costs.</dd>
<dt><strong>Broad slowdown</strong></dt>
<dd>Constrain powerful systems until people and institutions can understand, contest, and govern the risks.</dd>
<dt><strong>Differential acceleration</strong></dt>
<dd>Accelerate protective and beneficial capacities, slow or constrain dangerous capacities, and preserve friction where judgment is needed.</dd>
</dl>
</aside>

<!-- phil-passage-id: ch17-p0097 -->
The d/acc and def/acc movements show how this logic appears inside current technology culture. Vitalik Buterin's essay ["My techno-optimism"](https://vitalik.eth.limo/general/2023/11/27/techno_optimism.html) argues for a directional version of acceleration. He emphasizes defensive, decentralized, democratic, and differential technological development. The goal is not maximum speed everywhere. The goal is to accelerate technologies that make people and communities more capable of defending themselves, coordinating, preserving privacy, and resisting capture.

<!-- phil-passage-id: ch17-p0098 -->
Entrepreneur First's def/acc program gives a startup-world version of the same impulse. Sifted describes [def/acc](https://sifted.eu/articles/def-acc-entrepreneur-first) as a company-builder effort focused on technologies that defend against big threats to society, including cyber attacks, powerful AI, nuclear war, and pandemics. That rhetoric belongs in this chapter because it shows acceleration language being redirected. The point is no longer "accelerate everything." The point is "accelerate the capacities that help people withstand dangerous acceleration elsewhere."

<!-- phil-passage-id: ch17-p0099 -->
AI governance examples fit here. OpenAI's page on [Deployment Simulation](https://openai.com/index/deployment-simulation/) describes a method for predicting model behavior before release by simulating deployment-like contexts with candidate models. This is purposeful friction before release. It slows one part of deployment to improve judgment about another. Anthropic's [Responsible Scaling Policy](https://www.anthropic.com/responsible-scaling-policy), as of July 2026, lists version 3.3 as effective May 26, 2026 and frames safeguards around capability thresholds, risk reports, safety cases, external input, and possible pauses. These sources do not make Anthropic or OpenAI accelerationist movements. They show that major AI companies now build some frictions into the process of scaling.

<!-- phil-passage-id: ch17-p0100 -->
...
<!-- phil-passage-id: ch17-p0102 -->
<aside class="textbox shaded textbox--argument-template" role="note" aria-labelledby="differential-template">
<h3 id="differential-template">Argument Template: Differential Acceleration</h3>
<p><strong>P1.</strong> A technology should be accelerated when it strengthens beneficial or protective capacities under accountable conditions.</p>
<p><strong>P2.</strong> A technology should be slowed or constrained when it increases dangerous capacity faster than people can understand, contest, or govern it.</p>
<p><strong>C.</strong> The ethical question is which capabilities to accelerate, slow, protect, or redirect, not whether all AI development should move at one speed.</p>
</aside>

<!-- phil-passage-id: ch17-p0103 -->
...
<!-- phil-passage-id: ch17-p0112 -->
GitHub's announcement for the [Copilot coding agent](https://github.blog/news-insights/product-news/github-copilot-meet-the-new-coding-agent/) describes a tool that can be assigned issues, work in the background, and create pull requests. It also includes logs, draft pull requests, branch protections, constrained internet access, human review, and approval conditions before workflows run. Google's [Gemini Agent Mode](https://blog.google/products-and-platforms/products/gemini/gemini-app-updates-io-2025/) describes multi-step task orchestration across browsing, research, and integrations. OpenAI and Anthropic add evaluation and scaling policies around model deployment. These examples do not prove those companies share an accelerationist ideology. They show the design problem accelerationism makes visible: every agentic system removes some friction and adds other friction back.

<!-- phil-passage-id: ch17-p0113 -->
...
<!-- phil-section-id: ch17-s011 -->
## Running Example: The AI Coding Agent

<!-- phil-passage-id: ch17-p0118 -->
...
<!-- phil-section-id: ch17-s014 -->
### Acceleration Decision Matrix

<!-- phil-passage-id: ch17-p0132 -->
Use this matrix to turn the friction test into a design response.

<!-- phil-passage-id: ch17-p0133 -->
<table>
<caption>Design responses to common acceleration findings</caption>
<thead>
<tr><th scope="col">Finding</th><th scope="col">Design response</th></tr>
</thead>
<tbody>
<tr><th scope="row">The tool removes needless delay and has low risk.</th><td>Accelerate.</td></tr>
<tr><th scope="row">The tool removes delay but affects vulnerable people.</th><td>Accelerate only with review, appeal, monitoring, and disclosure.</td></tr>
<tr><th scope="row">The tool increases useful capacity but evidence is weak.</th><td>Sandbox before field deployment.</td></tr>
<tr><th scope="row">The tool improves efficiency by bypassing consent or accountability.</th><td>Redesign before rollout.</td></tr>
<tr><th scope="row">The tool creates irreversible or hard-to-repair harm.</th><td>Slow, restrict, or refuse deployment.</td></tr>
<tr><th scope="row">The tool expands protective capacity.</th><td>Prioritize and accelerate responsibly.</td></tr>
<tr><th scope="row">The tool expands dangerous capacity faster than safeguards.</th><td>Constrain until safeguards catch up.</td></tr>
<tr><th scope="row">The tool shifts gains to institutions while shifting risks to users or workers.</th><td>Redesign incentives, benefits, and contestability.</td></tr>
</tbody>
</table>
...
<!-- phil-passage-id: ch17-p0135 -->
Here is the audit in its simplest form:

<!-- phil-passage-id: ch17-p0136 -->
...
<!-- phil-section-id: ch17-s016 -->
### Field Applications

<!-- phil-passage-id: ch17-p0140 -->
...
<!-- phil-section-id: ch17-s017 -->
## What The Lens Reveals And What It Distorts

<!-- phil-passage-id: ch17-p0146 -->
...
<!-- phil-passage-id: ch17-p0152 -->
<aside class="textbox examples textbox--worked-argument" aria-labelledby="acceleration-ethics-template">
<h3 id="acceleration-ethics-template">Argument Template: Acceleration Ethics</h3>
<p><strong>P1.</strong> This AI system accelerates a specific capacity, workflow, decision, or institution.</p>
<p><strong>P2.</strong> That acceleration removes some forms of friction and preserves or adds others.</p>
<p><strong>P3.</strong> The ethical status of the acceleration depends on whether the removed friction was needless drag or moral infrastructure, who gains capacity, who absorbs risk, and who can contest the direction.</p>
<p><strong>C.</strong> A responsible design should accelerate the right capacity, preserve the right friction, and make the direction contestable.</p>
</aside>
...
<!-- phil-passage-id: ch17-p0156 -->
AI ethics asks for a reasoned account of which speed serves human judgment and which speed outruns it.

<!-- phil-section-id: ch17-s019 -->
## References

<!-- phil-passage-id: ch17-p0157 -->
- Andreessen, Marc. [The Techno-Optimist Manifesto](https://a16z.com/the-techno-optimist-manifesto/). Andreessen Horowitz, 2023. Used as a primary contemporary techno-optimist and explicit accelerationist source.
- Augustine. [The City of God, Book XX](https://www.newadvent.org/fathers/120120.htm). New Advent edition. Used for medieval eschatology, final judgment, and history interpreted in relation to divine disclosure.
- Bacon, Francis. [Francis Bacon](https://plato.stanford.edu/entries/francis-bacon/). *Stanford Encyclopedia of Philosophy*. Used for Bacon's Great Instauration, operative knowledge, collaboration, method, and the connection between knowledge and power.
- Bacon, Francis. [Novum Organum](https://history.hanover.edu/texts/bacon/novorg.html). Hanover Historical Texts edition. Used for Bacon's account of knowledge, power, method, and human action within nature.
- Beff Jezos and bayes. [Notes on e/acc principles and tenets](https://beff.substack.com/p/notes-on-eacc-principles-and-tenets). Beff's Newsletter, July 10, 2022. Used as a primary e/acc movement source. Treated as manifesto and self-understanding; the chapter does not rely on its thermodynamic claims as settled science.
- Bostrom, Nick. [The Vulnerable World Hypothesis](https://nickbostrom.com/papers/vulnerable.pdf). *Global Policy*, 2019. Used for the black-ball metaphor and differential technological development.
- Buterin, Vitalik. [My techno-optimism](https://vitalik.eth.limo/general/2023/11/27/techno_optimism.html). 2023. Used for d/acc, defensive acceleration, decentralization, democracy, and differential development.
- Collingridge, David. *The Social Control of Technology*. St. Martin's Press / Pinter, 1980. Used for the Collingridge dilemma: early control under uncertainty versus later control after entrenchment.
- Columbia University Press. [Hartmut Rosa, Social Acceleration: A New Theory of Modernity](https://cup.columbia.edu/book/social-acceleration/9780231148344/). Used for technological acceleration, social change, and pace-of-life acceleration.
- Critical Legal Thinking. [#ACCELERATE MANIFESTO for an Accelerationist Politics](https://criticallegalthinking.com/2013/05/14/accelerate-manifesto-for-an-accelerationist-politics/) by Nick Srnicek and Alex Williams. Used as a primary left-accelerationist source.
- Deleuze, Gilles. [Gilles Deleuze](https://plato.stanford.edu/entries/deleuze/). *Stanford Encyclopedia of Philosophy*. Used for Deleuze and Guattari, deterritorialization/reterritorialization, and the conceptual background for release/capture.
- Edinburgh University Press. [Benjamin Noys, *The Persistence of the Negative: A Critique of Contemporary Continental Theory*](https://edinburghuniversitypress.com/book-the-persistence-of-the-negative.html). Used for Noys's critique of affirmationism and return of negativity.
- Entrepreneur First / Sifted. [What is Def/acc? Matt Clifford on Entrepreneur First's new programme](https://sifted.eu/articles/def-acc-entrepreneur-first). Sifted, May 29, 2024. Used for def/acc as a startup and defensive-technology frame.
- Extropic. [Company site](https://www.extropic.ai/). Used for thermodynamic computing hardware, thermodynamic sampling units, and software claims; live source checked July 2026.
- Fisher, Mark. *Capitalist Realism: Is There No Alternative?* Zero Books, 2009. Used for the background idea that the future can appear politically cancelled under capitalist realism.
- Fisher, Mark. "Terminator vs Avatar" and related accelerationist materials in [*#Accelerate: The Accelerationist Reader*](https://www.urbanomic.com/book/accelerate/). Used for accelerationism's cultural and theoretical genealogy.
- Fridman, Lex. [Transcript for Guillaume Verdon: Beff Jezos, E/acc Movement, Physics, Computation & AGI](https://lexfridman.com/guillaume-verdon-transcript/). Lex Fridman Podcast #407, December 29, 2023. Used for Verdon's public explanation of e/acc, Kardashev-scale language, thermodynamics, AGI, and movement self-understanding.
- GitHub. [GitHub Copilot: Meet the new coding agent](https://github.blog/news-insights/product-news/github-copilot-meet-the-new-coding-agent/). Used as an agentic-workflow and governance-friction example; live product source checked July 2026.
- Google. [Gemini app updates from Google I/O 2025](https://blog.google/products-and-platforms/products/gemini/gemini-app-updates-io-2025/). Used for Gemini Agent Mode and ordinary-user agentic workflow context; live product source checked July 2026.
- Hegel, G. W. F. [Introduction to the Lectures on the Philosophy of History](https://history.hanover.edu/courses/excerpts/111hegel.html). Hanover College excerpt from the Fordham Internet Modern History Sourcebook. Used as a compact source for Hegel's progress/freedom account.
- Joachim of Fiore. [The Hauntings of Joachim de Fiore](https://churchlifejournal.nd.edu/articles/the-hauntings-of-joachim-de-fiore/). *Church Life Journal*, University of Notre Dame. Used for the three-age historical schema and later interpretations of historical rupture and renewal.
- Land, Nick. [Meltdown](https://www.urbanomic.com/chapter/fanged-noumena-meltdown/). In *Fanged Noumena*. Used for Land's techno-capital and singularity language.
- Land, Nick. [Fanged Noumena: Collected Writings 1987-2007](https://www.urbanomic.com/book/fanged-noumena/). Urbanomic / Sequence Press. Used for Land's 1990s cybercapitalism and accelerationist context.
- Le, Vincent. [A Conversation with Nick Land, Part 1](https://vincentl3.substack.com/p/a-conversation-with-nick-land-part-d2d). January 13, 2026. Used for Land's recent interview context around Kant, AI apocalypse, simulation hypotheses, LLMs, Deleuze and Guattari, and related themes.
- Le, Vincent. [A Conversation with Nick Land, Part 2](https://vincentl3.substack.com/p/a-conversation-with-nick-land-part-a4f). January 20, 2026. Used as recent public-facing Land context; live Substack source to recheck before publication.
- Le, Vincent. [A Conversation with Nick Land, Part 3](https://vincentl3.substack.com/p/a-conversation-with-nick-land-part-d8a). January 28, 2026. Used for public-facing context around Gnostic Calvinism; advanced sidebar/source-note material rather than core student argument.
- Lonsdale, Joe. [Accelerate or Die: Guillaume Verdon](https://blog.joelonsdale.com/p/ep-76-accelerate-or-die-guillaume). Used for Verdon/Beff/e/acc public identity and Extropic context.
- Mackay, Robin, and Armen Avanessian, eds. [#Accelerate: The Accelerationist Reader](https://www.urbanomic.com/book/accelerate/). Urbanomic, 2014; POD edition 2024. Used for the direct accelerationism genealogy, including Marx, Deleuze and Guattari, CCRU, Sadie Plant, Land, Fisher, Srnicek and Williams, Negarestani, and others.
- Marx, Karl. [Capital, Volume I, Chapter 15](https://www.marxists.org/archive/marx/works/1867-c1/ch15.htm). Used for the tool/machine distinction and machinery's relation to labor.
- Marx, Karl. [The Fragment on Machines](https://www.marxists.org/archive/marx/works/1857/grundrisse/ch14.htm). Used as a compact precursor for machinery, knowledge, and production.
- Musk, Elon. [The Secret Tesla Motors Master Plan](https://www.tesla.com/secret-master-plan). Tesla, August 2, 2006. Used as a product-strategy example of acceleration, staged scaling, and energy-transition rhetoric.
- Musk, Elon / SpaceX. [Making Life Multiplanetary](https://spacex.relayto.com/e/making-life-multiplanetary-ddvqil46?utm_source=tomegenius). Abridged transcript of Musk's 68th International Astronautical Congress presentation, September 28, 2017. Used as a civilizational-scale product rhetoric example.
- Negarestani, Reza. [Intelligence and Spirit](https://www.urbanomic.com/book/intelligence-and-spirit/). Urbanomic / Sequence Press, 2018. Used for rational inhumanism, intelligence, and the critique of reducing intelligence to mere process or selection.
...
- OpenAI. [Predicting model behavior before release by simulating deployment](https://openai.com/index/deployment-simulation/). Used as a governance-friction example before deployment; live source checked July 2026.
- Stanford Encyclopedia of Philosophy. [Consequentialism](https://plato.stanford.edu/entries/consequentialism/). Used for outcome, harm, benefit, and opportunity-cost reasoning.
- Stanford Encyclopedia of Philosophy. [Progress](https://plato.stanford.edu/entries/progress/). Used for the historical idea of progress.
- Stanford Encyclopedia of Philosophy. [Risk](https://plato.stanford.edu/entries/risk/). Used for risk, uncertainty, and responsibility for imposed risk.
- Srnicek, Nick, and Alex Williams. [Inventing the Future: Postcapitalism and a World Without Work](https://www.versobooks.com/en-gb/products/148-inventing-the-future). Verso, 2015 / updated edition. Used for the book-length left-accelerationist continuation: automation, post-work politics, public abundance, and technology as emancipatory capacity.
- Anthropic. [Responsible Scaling Policy](https://www.anthropic.com/responsible-scaling-policy) and [Responsible Scaling Policy v3](https://www.anthropic.com/news/responsible-scaling-policy-v3). Used as thresholded-governance examples; live source checked July 2026.
- Vallor, Shannon. "Virtues in the Digital Age." In Carissa Veliz, ed., [*The Oxford Handbook of Digital Ethics*](https://academic.oup.com/edited-volume/37078). Oxford University Press, 2024. Used for virtue ethics, digital environments, practical wisdom, and habits under conditions of technological mediation.
- Veliz, Carissa, ed. [*The Oxford Handbook of Digital Ethics*](https://academic.oup.com/edited-volume/37078). Oxford University Press, 2024. Used as a digital-ethics canon source, especially for velocity, virtue, automation, value alignment, and existential-risk context.
