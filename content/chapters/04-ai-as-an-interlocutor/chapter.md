...
<!-- phil-passage-id: ch04-p0003 -->
[David Chalmers](https://philarchive.org/archive/CHAWWT-8), for example, describes extended conversations with Claude and ChatGPT while exploring philosophical questions and possible new ideas. A research team led by [Ye and colleagues](https://openreview.net/attachment?id=ZZzXpyv65G&name=pdf) interviewed 21 professional philosophers about language models as critical-thinking tools. The study organized their possible uses into three interaction functions. A model might act as an **interlocutor** that enters a dialogue, a **monitor** that watches for gaps or errors, or a **respondent** that reacts to a philosopher's work. PHIL 123 uses a different three-role structure based on the stages of the course. Current models can lose track of subtle positions, supply shallow criticism, or produce fluent answers that the philosopher still has to assess.

<!-- phil-passage-id: ch04-p0004 -->
Philosophers also work inside companies building these systems. [Amanda Askell](https://askell.io/cv/) is a philosopher and research scientist at Anthropic, while [Iason Gabriel](https://www.iasongabriel.com/home) describes his work as philosopher and research scientist at Google DeepMind. Their roles show that philosophical judgment enters AI development as well as outside criticism of it.

<!-- phil-passage-id: ch04-p0005 -->
Language models display enough local skill with moral language to make the encounter intellectually useful. [Seth Lazar](https://blog.cosmos-institute.org/p/the-construction-of-moral-character) reports that frontier models can often recognize morally relevant details and connect them with reasons. They can also construct plausible arguments in text-based cases. But again, their performance is uneven. A model may reason well about one vignette and poorly about a nearby case, or it may produce an objection without recognizing how serious it is, or defend incompatible positions in separate conversations.

<!-- phil-passage-id: ch04-p0006 -->
...
<!-- phil-section-id: ch04-s003 -->
## Three Roles for AI in PHIL 123

<!-- phil-section-id: ch04-s004 -->
### Philosophical Practice Partner

<!-- phil-passage-id: ch04-p0007 -->
...
<!-- phil-section-id: ch04-s005 -->
### Research Mapper

<!-- phil-passage-id: ch04-p0009 -->
...
<!-- phil-section-id: ch04-s006 -->
### Project and Build Assistant

<!-- phil-passage-id: ch04-p0012 -->
...
<!-- phil-passage-id: ch04-p0014 -->
Exact permissions vary by assignment. Canvas identifies when AI use is required, permitted, limited, or prohibited, along with the process evidence students must preserve. Across all three roles, students inspect the contribution, decide what to use or change, preserve the required evidence, and explain the judgment behind the decision.

<!-- phil-passage-id: ch04-p0015 -->
<aside class="textbox shaded textbox--framework-map" role="note" aria-labelledby="three-ai-roles">
<h3 id="three-ai-roles">Framework Map: Three AI Roles in PHIL 123</h3>
<dl>
<dt><strong>Philosophical practice partner</strong></dt>
<dd>Supplies questions, counterexamples, comparisons, and objections. Check the ethical framework and argument before deciding how to respond.</dd>
<dt><strong>Research mapper</strong></dt>
<dd>Supplies claims, disagreements, stakeholders, search terms, and source leads. Open the sources and inspect the framing before deciding which routes deserve further inquiry.</dd>
<dt><strong>Project and build assistant</strong></dt>
<dd>Supplies alternatives, organization, drafting or production help, technical support, and feedback when permitted. Reconstruct and defend the decisions that shaped the project.</dd>
</dl>
</aside>

<!-- phil-passage-id: ch04-p0016 -->
...
<!-- phil-section-id: ch04-s007 -->
## ABC-R: Check the Contribution, Then Check the Use

<!-- phil-passage-id: ch04-p0017 -->
...
<!-- phil-passage-id: ch04-p0020 -->
The final letter evaluates the student's use.

<!-- phil-passage-id: ch04-p0021 -->
...
<!-- phil-section-id: ch04-s008 -->
### A: Accuracy and Evidence

<!-- phil-passage-id: ch04-p0023 -->
...
<!-- phil-passage-id: ch04-p0030 -->
The [UNESCO Recommendation on the Ethics of Artificial Intelligence](https://www.unesco.org/en/artificial-intelligence/recommendation-ethics) directs attention to affected groups, representation, human oversight, and the distribution of benefits and harms. Those concerns fit research mapping, but B also applies to a short tutor exchange. Consider strategies like asking whether the objection is serious, whether the chatbot has followed your preferred conclusion, and whether another framework would direct attention elsewhere.

<!-- phil-section-id: ch04-s010 -->
### C: Context and Relevance

<!-- phil-passage-id: ch04-p0031 -->
...
<!-- phil-section-id: ch04-s011 -->
### R: Responsible Use

<!-- phil-passage-id: ch04-p0035 -->
...
<!-- phil-passage-id: ch04-p0039 -->
[UNESCO's guidance for generative AI in education and research](https://www.unesco.org/en/articles/guidance-generative-ai-education-and-research) emphasizes human agency, privacy, pedagogical fit, and accountable use. The [International Center for Academic Integrity](https://academicintegrity.org/aws/ICAI/pt/sp/fundamental) grounds academic work in honesty, trust, fairness, respect, responsibility, and courage. R brings those considerations into one course question:

<!-- phil-passage-id: ch04-p0040 -->
...
<!-- phil-section-id: ch04-s012 -->
## Use AI to Learn

<!-- phil-passage-id: ch04-p0046 -->
...
<!-- phil-passage-id: ch04-p0047 -->
Recent studies have tested parts of that question in different settings. In a Turkish high-school mathematics experiment involving nearly 1,000 students, [Hamsa Bastani and colleagues](https://www.pnas.org/doi/10.1073/pnas.2422633122) found that unrestricted GPT access improved performance during practice. On a later unaided exam, that group performed 17 percent below the no-AI control. A more structured tutoring interface avoided the penalty by limiting direct answers and preserving more student effort.

<!-- phil-passage-id: ch04-p0048 -->
A randomized study of 117 university students by [Yizhou Fan and colleagues](https://doi.org/10.1111/bjet.13544) found that ChatGPT-supported students produced stronger essays during the assisted task without a corresponding significant advantage in knowledge or transfer. In another setting, [Greg Kestin and colleagues](https://www.nature.com/articles/s41598-025-97652-6) tested a purpose-built AI tutor with 194 Harvard physics students. The tutor used instructor materials, a structured sequence, feedback, and self-pacing. Students showed strong immediate learning gains, although the study did not measure retention or transfer and cannot establish the effects of ordinary chatbots in philosophy.

<!-- phil-passage-id: ch04-p0049 -->
...
<!-- phil-passage-id: ch04-p0058 -->
<aside class="textbox exercises textbox--judgment-practice" aria-labelledby="abcr-decision-trail">
<h3 id="abcr-decision-trail">Practice: Record One AI-Assisted Decision</h3>
<ol>
<li><strong>Contribution:</strong> State what the AI supplied, such as a question, objection, source lead, comparison, draft, design, code, or feedback.</li>
<li><strong>Decision:</strong> State what you used, revised, rejected, verified, ignored, or investigated further.</li>
<li><strong>ABC-R reason:</strong> Identify the accuracy, perspective, context, or responsible-use finding that explains the decision.</li>
<li><strong>Your work:</strong> State which judgment or ability remained yours and how you performed it.</li>
</ol>
</aside>

<!-- phil-passage-id: ch04-p0059 -->
...
<!-- phil-section-id: ch04-s013 -->
## References

<!-- phil-passage-id: ch04-p0061 -->
- Askell, Amanda. [*Curriculum Vitae*](https://askell.io/cv/). Used to verify Askell's philosophical training and current Anthropic role.
- Bastani, Hamsa, Osbert Bastani, Alp Sungu, Haosen Ge, Ozge Kabakci, and Rei Mariman. ["Generative AI without guardrails can harm learning: Evidence from high school mathematics"](https://www.pnas.org/doi/10.1073/pnas.2422633122). *Proceedings of the National Academy of Sciences* 122.26 (2025). Used for the contrast between assisted practice performance and later unaided performance in the study's mathematics setting.
- Chalmers, David J. ["What We Talk to When We Talk to Language Models"](https://philarchive.org/archive/CHAWWT-8). Preprint (2026). Used as a first-person example of a philosopher exploring philosophical questions with Claude and ChatGPT.
- Fan, Yizhou, Luzhen Tang, Huixiao Le, Kejie Shen, Shufang Tan, Yueying Zhao, Yuan Shen, Xinyu Li, and Dragan Gasevic. ["Beware of Metacognitive Laziness: Effects of Generative Artificial Intelligence on Learning Motivation, Processes, and Performance"](https://doi.org/10.1111/bjet.13544). *British Journal of Educational Technology* 56.2 (2025): 489-530. Used for the distinction between assisted writing quality and measured knowledge or transfer.
- Gabriel, Iason. [*Dr Iason Gabriel*](https://www.iasongabriel.com/home). Used to verify Gabriel's work as a philosopher and research scientist at Google DeepMind.
- International Center for Academic Integrity. [*The Fundamental Values of Academic Integrity*](https://academicintegrity.org/aws/ICAI/pt/sp/fundamental). Used for the integrity values included in Responsible Use.
- Kestin, Greg, Kelly Miller, Anna Klales, Timothy Milbourne, and Gregorio Ponti. ["AI Tutoring Outperforms In-Class Active Learning: An RCT Introducing a Novel Research-Based Design in an Authentic Educational Setting"](https://www.nature.com/articles/s41598-025-97652-6). *Scientific Reports* 15 (2025). Used for the bounded example of a purpose-built tutor and immediate learning outcomes.
- Lazar, Seth. ["Are Frontier Models Good at Ethics?"](https://blog.cosmos-institute.org/p/the-construction-of-moral-character). *Cosmos Institute* (2026). Used for the limited claim that frontier models can show local textual facility with moral reasons and arguments.
- McCord, Brendan. ["The Artificial Spectator"](https://blog.cosmos-institute.org/p/the-artificial-spectator). *Cosmos Institute* (2025). Used for the Smith-inspired argument about assistance and the formation of practical judgment.
- National Institute of Standards and Technology. [*Artificial Intelligence Risk Management Framework: Generative Artificial Intelligence Profile*](https://doi.org/10.6028/NIST.AI.600-1). NIST AI 600-1 (2024). Used for confabulation, information integrity, provenance, and context-sensitive risk evaluation.
- O'Neill, Elizabeth, Michal Klincewicz, and Michiel Kemmer. ["Ethical Issues with Artificial Ethics Assistants"](https://doi.org/10.1093/oxfordhb/9780198857815.013.17). In *The Oxford Handbook of Digital Ethics*, edited by Carissa Veliz. Oxford University Press (2022). Used for the benefits and risks of AI-supported moral deliberation.
- Perkins, Mike, Jasper Roe, and Leon Furze. ["Reimagining the Artificial Intelligence Assessment Scale: A Refined Framework for Educational Assessment"](https://doi.org/10.53761/rrm4y757). *Journal of University Teaching and Learning Practice* 22.7 (2025). Used for task-level AI permissions and boundaries.
- UNESCO. [*Guidance for Generative AI in Education and Research*](https://www.unesco.org/en/articles/guidance-generative-ai-education-and-research) (2023). Used for human agency, privacy, pedagogical fit, and accountable educational use.
- UNESCO. [*Recommendation on the Ethics of Artificial Intelligence*](https://www.unesco.org/en/artificial-intelligence/recommendation-ethics) (2021). Used for attention to affected groups, representation, human oversight, and the distribution of benefits and harms.
- Ye, et al. ["Language Models as Critical Thinking Tools: A Case Study of Philosophers"](https://openreview.net/attachment?id=ZZzXpyv65G&name=pdf). COLM 2024. Used for the interlocutor, monitor, and respondent roles derived from interviews with 21 professional philosophers.
