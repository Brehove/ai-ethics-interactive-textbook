...
const digestBytes = await readFile(digestFile); let assetCount = 0;
...
const report = { schemaVersion: 1, baseUrl: base, checkedAt: new Date().toISOString(), routes: routeResults, assetCount, assetManifestSha256: createHash("sha256").update(digestBytes).digest("hex") };
